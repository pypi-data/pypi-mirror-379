...
2. Build and run with live reload (recommended during development):
   [cyan]RELOAD=1 docker compose up --build[/cyan]

3. Find the assigned host port:
   [cyan]docker port {project_name.replace(' ', '-').lower()} 8080/tcp[/cyan]

4. To change the port:
   [cyan]PORT=1010 RELOAD=1 docker compose up --build[/cyan]
"""
