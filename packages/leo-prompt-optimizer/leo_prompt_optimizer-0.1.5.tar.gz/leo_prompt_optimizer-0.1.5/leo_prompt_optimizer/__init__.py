...
It uses open-source models (via Groq API) to refine prompts into structured, high-quality instructions.
...
from .optimizer import optimize_prompt, set_groq_api_key

__all__ = ["optimize_prompt", "set_groq_api_key"]
