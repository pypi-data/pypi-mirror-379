...
class AuthRouter(APIRouter):
    ...
    async def role_checker(self, request: Request, permission_service=..., user: AuthUser = ...): ...
    async def permission_checker(self, request: Request, permission_service=..., user: AuthUser = ...): ...
