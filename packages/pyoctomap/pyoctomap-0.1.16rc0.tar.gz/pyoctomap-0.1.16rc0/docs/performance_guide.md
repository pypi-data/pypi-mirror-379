...
Optimization tips and performance benchmarks for OctoMap2Python.

## Performance Overview

OctoMap2Python is designed for high-performance 3D occupancy mapping with minimal overhead compared to the native C++ library.
