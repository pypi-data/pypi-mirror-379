...
Detailed documentation of the OctoMap2Python build system and scripts.

## Overview

The build system automates the entire process of building OctoMap2Python with bundled shared libraries, ensuring zero external dependencies.
