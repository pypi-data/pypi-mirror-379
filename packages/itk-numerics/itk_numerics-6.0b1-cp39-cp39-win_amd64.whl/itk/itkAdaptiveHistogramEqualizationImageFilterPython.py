...
def adaptive_histogram_equalization_image_filter(*args: itkt.ImageLike,  alpha: float=..., beta: float=..., use_lookup_table: bool=..., kernel=..., radius: Union[int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def moving_histogram_image_filter_base(*args: itkt.ImageLike,  kernel=..., radius: Union[int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def moving_histogram_image_filter(*args: itkt.ImageLike,  kernel=..., radius: Union[int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
