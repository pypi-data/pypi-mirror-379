...
def binary_morphological_opening_image_filter(*args: itkt.ImageLike,  foreground_value: int=..., background_value: int=..., kernel: itkt.FlatStructuringElement=..., radius: Union[Sequence[int], int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
