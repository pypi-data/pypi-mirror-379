...
def white_top_hat_image_filter(*args: itkt.ImageLike,  safe_border: bool=..., algorithm=..., force_algorithm: bool=..., kernel: itkt.FlatStructuringElement=..., radius: Union[int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
