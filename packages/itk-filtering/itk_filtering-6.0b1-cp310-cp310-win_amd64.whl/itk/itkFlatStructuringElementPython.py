...
def moving_histogram_image_filter_base(*args: itkt.ImageLike,  kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def kernel_image_filter(*args: itkt.ImageLike,  kernel: itkt.FlatStructuringElement=..., radius: Union[Sequence[int], int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
