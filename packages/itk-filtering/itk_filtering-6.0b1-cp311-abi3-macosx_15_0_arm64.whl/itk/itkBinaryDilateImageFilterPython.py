...
def binary_dilate_image_filter(*args: itkt.ImageLike,  dilate_value: float=..., foreground_value: float=..., background_value: float=..., boundary_to_foreground: bool=..., kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[Sequence[int], Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
...
@helpers.accept_array_like_xarray_torch
def binary_morphology_image_filter(*args: itkt.ImageLike,  foreground_value: float=..., background_value: float=..., boundary_to_foreground: bool=..., kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[Sequence[int], Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
