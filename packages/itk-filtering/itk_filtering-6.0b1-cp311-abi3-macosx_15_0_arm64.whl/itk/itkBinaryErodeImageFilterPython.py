...
def binary_erode_image_filter(*args: itkt.ImageLike,  erode_value: float=..., foreground_value: float=..., background_value: float=..., boundary_to_foreground: bool=..., kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[Sequence[int], Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
