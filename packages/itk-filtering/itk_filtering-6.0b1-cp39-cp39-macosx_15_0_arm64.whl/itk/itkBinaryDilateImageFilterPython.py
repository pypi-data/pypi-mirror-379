...
def binary_dilate_image_filter(*args: itkt.ImageLike,  dilate_value: int=..., foreground_value: int=..., background_value: int=..., boundary_to_foreground: bool=..., kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[Sequence[int], int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
