...
def white_top_hat_image_filter(*args: itkt.ImageLike,  safe_border: bool=..., algorithm=..., force_algorithm: bool=..., kernel: itkt.FlatStructuringElement=..., radius: Union[Sequence[int], Sequence[int], int]=...,**kwargs)-> itkt.ImageSourceReturn:
