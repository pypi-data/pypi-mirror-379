...
class Builder:
    ...
    def __init__(self, config: Config, parser: Parser):
        ...
        self.base_themes_path = Path("themes") if Path("themes").exists() else importlib.resources.files("docsmaker") / "themes"
        self.theme_path = self.base_themes_path / self.config.theme
        ...
        while current_path and str(current_path) not in visited:
            ...
            if config_path.exists():
                with open(config_path, 'r', encoding='utf-8') as f:
                    ...
                    if extends:
                        current_path = self.base_themes_path / extends
                    else:
                        current_path = None
            else:
                current_path = None
