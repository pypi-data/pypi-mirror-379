...
def gql_get_pull_request(auth_scheme: AuthenticationScheme, *, owner: str, repo: str, pull_request_id: int) -> GQLPullRequest:
    ...
    """
def gql_list_pull_requests(auth_scheme: AuthenticationScheme, *, owner: str, repo: str, states: list[GQLPullRequestState] | None = None, labels: list[str] | None = None, head: str | None = None, base: str | None = None, per_page: int | None = None, cursor: str | None = None, from_last: bool = False, order_by: GQLIssueOrderBy = ..., direction: GQLDirection = ...) -> tuple[list[GQLPullRequest], GithubApiCursorMeta]:
