...
class SqlServerClient:
    def __init__(self) -> None:
        self.connection_string = (
            "mssql+pyodbc://App_nfe_alert:W4dm<3U6GUn2j60*PZq)@ARBAS0229/Tecnologia"
...
if __name__ == "__main__":
    ...
    # print(f"Registro insertado con ID: {registro.id}, estado: {ESTADO_MEANINGS[EstadoMonitoreo(registro.estado)]}")
