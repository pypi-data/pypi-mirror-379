...
from scrapy_redis_sentinel import scrapy_log
from scrapy_redis_sentinel.utils import get_track_id
...
class Scheduler(object):
    ...
    def next_request(self):
        ...
        if request and self.stats:
            scrapy_log.info(f"get request from next_request: spider name: {self.spider.name}, {request.__dict__}").track_id(get_track_id(request)).commit()
