...
client = OptycodeAPI(auth_token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjb21wYW55X2lkIjoiMTYiLCJjb21wYW55X25hbWUiOiJvcHR5Y29kZSIsImluZHVzdHJ5IjoiU29mdHdhcmUiLCJleHAiOjE3NTg2NTg2NTJ9.TjrzV_XSL5uiKj0TnGO2Yzdykbuiux2AIdbwp-Cd7fY")
response = client.send_model_data_async(question="sdk_test_async_gateway", answer="sdk_test_answer_async_gateway", model_id=2)
