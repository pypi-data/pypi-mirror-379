...
如果你不需要使用继承、重写等特性，而只是需要一个用来操作 MongoDB 的 ODM，我们为你准备了另一款更合适的工具 —— [mongo](https://github.com/xucanbiao/skk/tree/main/skk/mongo) 。

[源码](https://github.com/xucanbiao/skk/tree/main/skk/objdb)
