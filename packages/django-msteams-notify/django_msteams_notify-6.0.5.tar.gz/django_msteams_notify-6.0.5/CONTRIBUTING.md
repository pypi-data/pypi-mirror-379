...
Report bugs at https://github.com/audreyfeldroy/django_msteams_notify/issues.
...
The best way to send feedback is to file an issue at https://github.com/audreyfeldroy/django_msteams_notify/issues.
...
Ready to contribute? Here's how to set up `django_msteams_notify` for local development.

1. Fork the `django_msteams_notify` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/django_msteams_notify.git
   ```

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development:

   ```sh
   mkvirtualenv django_msteams_notify
...
```sh
pytest tests.test_django_msteams_notify
```
