...
class DatabaseService(ABC, Generic[T]):
    ...
    def __init__(self, *, dynamodb: DynamoDB = None, table_name: str = None):
        ...
        self.dynamodb.table_name = (
            table_name or self.dynamodb.table_name or os.getenv("DYNAMODB_TABLE_NAME")
        )

        if not self.dynamodb.table_name:
            raise ValueError("Table name is required")

        self.table_name = self.dynamodb.table_name
