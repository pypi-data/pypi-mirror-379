...
# PyTest class removed - setuptools.command.test is deprecated
...
# DummyPyTest class removed - setuptools.command.test is deprecated


setup(
    name="msfastpbkdf2",
    description="A faster implementation of PBKDF2 with Python 3.12+ support",
    version="0.6.0",
