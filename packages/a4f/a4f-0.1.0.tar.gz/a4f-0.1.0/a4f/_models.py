...
import os
import inspect
from typing import TYPE_CHECKING, Any, Dict, Type, Tuple, Union, Generic, TypeVar, Callable, Optional, cast
...
class BaseModel(pydantic.BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        """The ID of the request, returned via the X-Request-ID header. Useful for debugging requests and reporting issues to A4F.
