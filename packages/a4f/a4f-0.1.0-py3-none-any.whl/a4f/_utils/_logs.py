...
logger: logging.Logger = logging.getLogger("a4f")
...
def _basic_config() -> None:
    # e.g. [2023-10-05 14:12:26 - a4f._base_client:818 - DEBUG] HTTP Request: POST http://127.0.0.1:4010/foo/bar "200 OK"
    logging.basicConfig(
