...
class BaseClient(Generic[_HttpxClientT, _DefaultStreamT]):
    ...
    def __init__(
        ...
        *,
        ...
        if max_retries is None:  # pyright: ignore[reportUnnecessaryComparison]
            raise TypeError(
                "max_retries cannot be None. If you want to disable retries, pass `0`; if you want unlimited retries, pass `math.inf` or a very high number; if you want the default behavior, pass `a4f.DEFAULT_MAX_RETRIES`"
            )
    ...
    def _validate_headers(
        ...
        Args:
            headers_dict: The merged headers dictionary
            custom_headers: The custom headers provided by the user
    ...
    def user_agent(self) -> str:
        return f"{self.__class__.__name__}/Python"
    ...
    def platform_headers(self) -> Dict[str, str]:
        ...
        return platform_headers(platform=self._platform)
...
def platform_headers(*, platform: Platform | None) -> Dict[str, str]:
    return {
...
def _merge_mappings(
    obj1: Mapping[_T_co, Union[_T]],
    obj2: Mapping[_T_co, Union[_T]],
) -> Dict[_T_co, _T]:
    ...
    """
    merged = {**obj1, **obj2}
    return {key: value for key, value in merged.items() if not isinstance(value, NotGiven)}
