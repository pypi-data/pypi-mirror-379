...
# TestPyPI Upload Script for personal-doc-library
# Usage: ./upload_to_testpypi.sh

set -e

echo "🚀 TestPyPI Upload Script for personal-doc-library"
echo "================================================"
