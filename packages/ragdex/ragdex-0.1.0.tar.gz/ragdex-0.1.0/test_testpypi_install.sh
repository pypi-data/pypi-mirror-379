...
echo ""
echo "📦 Installing personal-doc-library from TestPyPI..."
echo ""
...
for cmd in pdlib-cli pdlib-mcp pdlib-indexer pdlib-webmonitor; do
    if [ -f "./bin/$cmd" ]; then
        echo "   ✓ $cmd found"
    else
        echo "   ✗ $cmd NOT found"
...
if ./bin/pdlib-cli --help > /dev/null 2>&1; then
    echo "   ✓ pdlib-cli --help works"
else
    echo "   ✗ pdlib-cli --help failed"
fi
...
echo "2. Test with: uv pip install personal-doc-library"
echo ""
