...
class CycloneAddConf(object):
    ...
    def __init__(self, description=None, destinations=None, is_etl=None, name=None, old_name=None, run_once=None, run_once_complete=None, schedule=None, schedules=None, source=None, status=None):  # noqa: E501
