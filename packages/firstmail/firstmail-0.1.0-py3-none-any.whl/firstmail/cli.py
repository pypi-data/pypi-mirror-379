...
Examples:
  ...
  %(prog)s count                        # Count total messages
    ...
    parser.add_argument('--no-ssl', dest='ssl', action='store_false', default=True,
                       help='Disable SSL (use port 143 instead of 993)')
    
    subparsers = parser.add_subparsers(dest='command', help='Available commands')
    
    parser_read_last = subparsers.add_parser('read-last', aliases=['last'], 
                                           help='Read the most recent email')
    ...
    parser_read_all = subparsers.add_parser('read-all', aliases=['all'], 
                                          help='Read all emails')
    ...
    parser_watch.add_argument('--interval', type=int, default=30, 
                            help='Check interval in seconds (default: 30)')
    parser_watch.add_argument('--show-body', action='store_true', 
                            help='Show email body preview')
