...
| oci://harbor.cta-observatory.org/dpps | cert-generator-grid | v3.1.0-rc2 |
| oci://harbor.cta-observatory.org/dpps | iam(dpps-iam) | v0.1.0-rc7 |
...
| database.default | string | `"postgresql+psycopg://rucio:XcL0xT9FgFgJEc4i3OcQf2DMVKpjIWDGezqcIPmXlM@bdms-postgresql:5432/rucio"` | The Rucio database connection URI |
...
| iam.bootstrap.config.users[0].groups[0] | string | `"ctao_dpps_test"` |  |
...
| iam.bootstrap.config.users[1].groups[0] | string | `"alt_ctao_dpps_test"` |  |
...
| iam.bootstrap.config.users[3].groups[0] | string | `"ctao_dpps_test"` |  |
...
| rucio-daemons.config.database.default | string | `"postgresql+psycopg://rucio:XcL0xT9FgFgJEc4i3OcQf2DMVKpjIWDGezqcIPmXlM@bdms-postgresql:5432/rucio"` | Specifies the connection URI for the Rucio database, these settings will be written to 'rucio.cfg' |
...
| rucio-server.config.database.default | string | `"postgresql+psycopg://rucio:XcL0xT9FgFgJEc4i3OcQf2DMVKpjIWDGezqcIPmXlM@bdms-postgresql:5432/rucio"` | The database connection URI for Rucio |
