...
setup_kwargs = {
    ...
    'extras_require': {       'dev': [       'aedev_project_tpls', 'aedev_namespace_root_tpls', 'ae_base', 'ae_deep', 'ae_django_utils',
                       ...
                       'ae_updater', 'ae_console', 'ae_shell', 'ae_lockname', 'ae_progress', 'ae_sys_core',
                       'ae_sys_data', 'ae_sys_core_sh', 'ae_sys_data_sh', 'ae_db_core', 'ae_db_ora', 'ae_db_pg',
                       'ae_transfer_service', 'ae_sideloading_server', 'ae_gui', 'ae_kivy_glsl', 'ae_kivy_dyn_chi',
                       'ae_kivy_relief_canvas', 'ae_kivy', 'ae_kivy_auto_width', 'ae_kivy_file_chooser',
                       'ae_kivy_iterable_displayer', 'ae_kivy_qr_displayer', 'ae_kivy_sideloading',
                       'ae_kivy_user_prefs', 'ae_lisz_app_data', 'ae_enaml_app', 'ae_ae', 'sphinx', 'sphinx-rtd-theme',
                       'sphinx_autodoc_typehints', 'sphinx_paramlinks', 'ae_dev_ops', 'anybadge', 'coverage-badge',
                       'aedev_git_repo_manager', 'flake8', 'mypy', 'pylint', 'pytest', 'pytest-cov', 'pytest-django',
                       'typing', 'types-setuptools'],
