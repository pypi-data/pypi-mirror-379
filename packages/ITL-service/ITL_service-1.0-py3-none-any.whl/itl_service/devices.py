...
#----------------------------------------------- Funciones Recurrentes -----------------------------------------------------------
    ...
    # Método para obtener los endpoints desde archivo JSON
    def GetEndpoints(self,ruta: str = "rutas.json") -> Dict[str, str]:
        """
        Método para obtener los endpoints desde archivo JSON
        
        Args:
            ruta (string) : Ruta donde se cargarán las direcciones relativas para los diferentes endpoints. Por defecto en la ruta "Endpoints/rutas.json"
        """
        rutas_endpoints = self.cargar_json(ruta)
        return rutas_endpoints
    ...
    def GetPath(self, modulo:str, key_device:bool = False) -> str:
        ...
        """
        ruta_modulo = self.rutas.get(modulo)
        if not ruta_modulo:
