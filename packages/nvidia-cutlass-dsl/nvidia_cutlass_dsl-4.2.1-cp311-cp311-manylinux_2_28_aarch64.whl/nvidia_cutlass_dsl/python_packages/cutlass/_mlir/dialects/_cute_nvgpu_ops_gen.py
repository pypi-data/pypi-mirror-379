...
class ArchMmaSM80Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, opA, opB, opC, *, int_overflow=None, binary_op=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1321')) else
      _ods_ir.AttrBuilder.get('anonymous_1321')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1321')) else
      _ods_ir.AttrBuilder.get('anonymous_1321')(b_type, context=_ods_context))
...
class ArchMmaSM80SparseOp(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, c_type, metadata, opA, opB, opC, opE, *, int_overflow=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1328')) else
      _ods_ir.AttrBuilder.get('anonymous_1328')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1328')) else
      _ods_ir.AttrBuilder.get('anonymous_1328')(b_type, context=_ods_context))
    attributes["c_type"] = (c_type if (
    isinstance(c_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1331')) else
      _ods_ir.AttrBuilder.get('anonymous_1331')(c_type, context=_ods_context))
    attributes["metadata"] = (metadata if (
    isinstance(metadata, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1334')) else
      _ods_ir.AttrBuilder.get('anonymous_1334')(metadata, context=_ods_context))
    if int_overflow is not None: attributes["int_overflow"] = (int_overflow if (
        isinstance(int_overflow, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('CuteMMAIntOverflowAttr')) else
          _ods_ir.AttrBuilder.get('CuteMMAIntOverflowAttr')(int_overflow, context=_ods_context))
...
class ArchMmaSM89Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, opA, opB, opC, *, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1340')) else
      _ods_ir.AttrBuilder.get('anonymous_1340')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1340')) else
      _ods_ir.AttrBuilder.get('anonymous_1340')(b_type, context=_ods_context))
    results.extend(res)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ArchMmaSM90Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shapeMNK, a_op, a_type, a_major, b_op, b_type, b_major, c_op, cd_type, accum, *, a_neg=None, b_neg=None, saturate=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1370')) else
      _ods_ir.AttrBuilder.get('anonymous_1370')(a_type, context=_ods_context))
    ...
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1370')) else
      _ods_ir.AttrBuilder.get('anonymous_1370')(b_type, context=_ods_context))
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1373')) else
      _ods_ir.AttrBuilder.get('anonymous_1373')(cd_type, context=_ods_context))
...
class ArchMmaSM120BlockScaledOp(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, vec_size, a_type, b_type, sf_type, opA, opB, opC, sfA, sfB, *, byte_id_a=None, byte_id_b=None, thread_id_a=None, thread_id_b=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1351')) else
      _ods_ir.AttrBuilder.get('anonymous_1351')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1351')) else
      _ods_ir.AttrBuilder.get('anonymous_1351')(b_type, context=_ods_context))
    attributes["sf_type"] = (sf_type if (
    isinstance(sf_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1354')) else
      _ods_ir.AttrBuilder.get('anonymous_1354')(sf_type, context=_ods_context))
    results.append(res)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class MakeTmaDescTiledAtOp(_ods_ir.OpView):
  ...
  def __init__(self, gmem_view, smem_layout, cta_value_tile, tma_desc_addr, mode, *, num_multicast=None, tma_internal_type=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def make_tma_desc_tiled_at(gmem_view, smem_layout, cta_value_tile, tma_desc_addr, mode, *, num_multicast=None, tma_internal_type=None, loc=None, ip=None) -> _ods_ir.Operation:
  return MakeTmaDescTiledAtOp(gmem_view=gmem_view, smem_layout=smem_layout, cta_value_tile=cta_value_tile, tma_desc_addr=tma_desc_addr, mode=mode, num_multicast=num_multicast, tma_internal_type=tma_internal_type, loc=loc, ip=ip)
...
class MakeTmaDescTiledOp(_ods_ir.OpView):
  ...
  def __init__(self, result, gmem_view, smem_layout, cta_value_tile, mode, *, num_multicast=None, tma_internal_type=None, unpacked=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if tma_internal_type is not None: attributes["tma_internal_type"] = (tma_internal_type if (
        ...
        not _ods_ir.AttrBuilder.contains('TypeAttr')) else
          _ods_ir.AttrBuilder.get('TypeAttr')(tma_internal_type, context=_ods_context))
    if unpacked is not None: attributes["unpacked"] = (unpacked if (
        isinstance(unpacked, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('BoolAttr')) else
          _ods_ir.AttrBuilder.get('BoolAttr')(unpacked, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
  ...
  @builtins.property
  def unpacked(self):
    if "unpacked" not in self.operation.attributes:
      return None
    return self.operation.attributes["unpacked"]

  @unpacked.setter
  def unpacked(self, value):
    if value is not None:
      self.operation.attributes["unpacked"] = value
    elif "unpacked" in self.operation.attributes:
      del self.operation.attributes["unpacked"]
...
def make_tma_desc_tiled(result, gmem_view, smem_layout, cta_value_tile, mode, *, num_multicast=None, tma_internal_type=None, unpacked=None, loc=None, ip=None) -> _ods_ir.Value:
  return MakeTmaDescTiledOp(result=result, gmem_view=gmem_view, smem_layout=smem_layout, cta_value_tile=cta_value_tile, mode=mode, num_multicast=num_multicast, tma_internal_type=tma_internal_type, unpacked=unpacked, loc=loc, ip=ip).result
