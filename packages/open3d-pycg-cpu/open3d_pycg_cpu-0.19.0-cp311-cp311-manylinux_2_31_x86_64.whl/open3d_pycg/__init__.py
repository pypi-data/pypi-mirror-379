...
import warnings
from open3d_pycg._build_config import _build_config
...
if _build_config["BUILD_CUDA_MODULE"]:
    ...
    try:
        ...
        if _pybind_cuda.open3d_core_cuda_device_count() > 0:
            from open3d_pycg.cuda.pybind import (
                core,
                camera,
                data,
                geometry,
            ...
            from open3d_pycg.cuda import pybind
...
if __DEVICE_API__ == "cpu":
    from open3d_pycg.cpu.pybind import (
        core,
        camera,
        data,
        geometry,
    ...
    from open3d_pycg.cpu import pybind
...
def _insert_pybind_names(skip_names=()):
    ...
    for modname in sys.modules:
        if "open3d_pycg." + __DEVICE_API__ + ".pybind" in modname:
...
import open3d_pycg.visualization
