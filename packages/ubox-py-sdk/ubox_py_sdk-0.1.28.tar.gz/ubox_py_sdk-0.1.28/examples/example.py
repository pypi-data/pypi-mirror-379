...
def demo_local_install(device):
    ...
    device.local_install_app(
        "/Users/xutianyi/Documents/lain_code/py-project/ubox-py-sdk/qqmusic_64_14.9.0.1_android_ra266691c_20250917222854_release.apk")
...
def demo_debug_mode_auto_occupy():
    try:
        ...
        with operation_timer("截图并裁剪"):
            # screenshot_result = device.screenshot(label="demo", img_path="./screenshots", crop=(0.42, 0.78, 0.58, 0.85))
            screenshot_result = device.screenshot(label="demo", img_path="./screenshots", crop=(561.87, 1762.37, 739.04, 1872.60))
            print(f"截图并裁剪: {screenshot_result}")
