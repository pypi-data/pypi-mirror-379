...
#
# Note: The function form illustrates both the standard S/N case (uncorrelated
# noise) and an empirical way of treating correlated noise. The empirical part
# is not generic and must be calibrated on real data, so it is only shown as an
# illustration, not a ready-to-use prescription (see Fig.11 from
