...
class WriteConfig:
    def __init__(self,
        ...
        self.config_path = config_path if config_path is not None else os.path.join(self.base_dir, "config.json")
        self.overrides = {
        ...
        self.config = config_dict if config_dict is not None else load_config(self.config_path)
