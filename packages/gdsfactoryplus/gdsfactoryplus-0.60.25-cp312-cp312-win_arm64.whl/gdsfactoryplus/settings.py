...
class Settings(pyds.BaseSettings):
    ...
    def settings_customise_sources(
        ...
        project_dir = gfp_project.maybe_find_docode_project_dir()
    ...
    def _validate_ignore(self) -> Self:
        ...
        """Expand glob patterns in ignore list."""
        repodir = Path(gfp_project.maybe_find_docode_project_dir() or ".").resolve()
...
if __name__ == "__main__":
    sys.stdout.write(get_settings().model_dump_json(indent=2))
