...
This is Coodhi Scrapper, a Python package that I hope will give more people access to soccer data.

To install Coodhi_Scrapper, run ```pip install Coodhi_Scrapper``` from the command line.
...
For documentation, head over to the [Read the Docs page](https://).

Join our [Discord](https://discord.gg/C5N8dqCJAq)!

I'd love to hear your feedback, bugs you find, or new features you want! The best way is to open an issue on this repository and I can respond to it there. Otherwise, you can reach me via email at vvimos@coodhi.com.
