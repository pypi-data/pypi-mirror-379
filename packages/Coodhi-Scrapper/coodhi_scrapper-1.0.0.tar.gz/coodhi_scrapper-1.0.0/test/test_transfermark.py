...
from Coodhi_Scrapper import Transfermarkt
from Coodhi_Scrapper.transfermarkt import comps
from Coodhi_Scrapper.scraperfc_exceptions import InvalidLeagueException, InvalidYearException
