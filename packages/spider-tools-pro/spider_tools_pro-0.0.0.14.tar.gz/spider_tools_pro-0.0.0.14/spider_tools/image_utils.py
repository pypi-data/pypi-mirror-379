...
def json_load_img(resp_str: str, save_dir: str = "imgs"):
    ...
    #
    # # 示例2: 使用新的便捷方法
    # print("2. 使用便捷方法返回图片信息:")
    # try:
    #     image_info = tool.generate_image_content(
    #         prompt="美丽的风景",
    #         method="http"
    #     )
    #
    ...
    #         print(f"图片大小: {info['size']} bytes")
    #         print(f"Base64内容前50字符: {info['base64_content'][:50]}...")
    #         print("---")
    #
    # except Exception as e:
    #     print(f"请求失败: {e}")
    ...
    # try:
    #     # 创建带保存目录的工具实例
    #     tool_with_save = AIImageTool(
    #         access_key="AKLTNGFjOTNhODIwYTY3NGRmYjk2NjBjNmRkOTAyMjRjZGY",
    #         secret_key="T0dNM1pqUmlaRGs0T0dJM05HWXpZV0poTm1NelpqUTVPREZsTmpKaU1tRQ==",
    #         save_dir="generated_images"
    #     )
    #
    #     results = tool_with_save.generate_image(
    #         prompt="科幻城市",
    #         method="http",
    #         save_to_local=True
    #     )
    ...
    #         print(f"图片大小: {result.size} bytes")
    #
    # except Exception as e:
    #     print(f"请求失败: {e}")