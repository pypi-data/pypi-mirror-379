...
class BaseRunner:
    ...
    def _enrich_session_context(self, session_context: Optional[Dict[str, Any]], agent_name: str) -> SessionContext:
        ...
        # Extract team_id and account_id from YAML root fields
        team_id = None
        ...
        context_data = {
            ...
            'team_identifier': team_id or 'unknown',
