...
class FeastClient:
    ...
    def create_table(self,
        ...
        entities = _get_entity_from_schema(feast_table_name, df.schema)
    ...
    def read_offline_table(self, table_name: str, database_name: str, columns_df: pandas.DataFrame) -> pandas.DataFrame:
        """
        ...
        result = self._client.get_historical_features(entity_df=columns_df, features=features)
        return result.to_df()
