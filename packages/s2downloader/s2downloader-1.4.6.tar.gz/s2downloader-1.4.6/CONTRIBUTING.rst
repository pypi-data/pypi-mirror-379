...
Report bugs at https://git.gfz-potsdam.de/fernlab/products/s2downloader/issues.
...
The best way to send feedback is to file an issue at https://git.gfz-potsdam.de/fernlab/products/s2downloader/issues.
...
2. Clone your fork locally::
    ...
    $ git clone git@git.gfz-potsdam.de:fernlab/products/s2downloader.git
...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check
   https://git.gfz-potsdam.de/fernlab/products/s2downloader/-/merge_requests
