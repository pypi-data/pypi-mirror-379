...
def handle_relationships(packages: list[Package]) -> list[Relationship]:
    ...
    for package in packages:
        if package.found_by == "python-installed-package-cataloger":
            package_metadata: WheelEggMetadata = cast("WheelEggMetadata", package.metadata)
            for dep in package_metadata.dependencies if package_metadata.dependencies else []:
