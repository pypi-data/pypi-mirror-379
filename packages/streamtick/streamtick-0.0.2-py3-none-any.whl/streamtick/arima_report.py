...
def ArimaReport():
    ...
    This function creates input fields for entering ARIMA model scores and
    stores a qualitative report dictionary in st.session_state after a button
    is clicked. It now includes advanced metrics for a more detailed analysis.

    Developers can call this method and then retrieve the report dictionary
    from st.session_state['arima_report'].
    """
    ...
    if st.button("Generate Report", key="generate_report_btn"):
        ...
        # Store the complete report dictionary in session state
        st.session_state['arima_report'] = report
        st.success("Report generated successfully!")

        # Display the report immediately after it's generated
        st.write("---")
