...
class TrainingState(Stateful):
    ...
    Since this object is compliant with the Stateful protocol, DCP will automatically call state_dict/load_stat_dict as needed in the
    dcp.save/load APIs. We take advantage of this wrapper to hande calling distributed state dict methods on the model
    and optimizer.
    ...
    def __init__(
        ...
        Args:
            ...
            global_rank (int, optional): The global rank of the pytorch process. Defaults to None.
            micro_batch_size (int, optional): The micro batch size. Defaults to None.
            global_batch_size (int, optional): The global batch size. Defaults to None.
        """
