"""Intercepts for user workload code."""
...
class _WorkloadSignals:
    ...
    def heartbeat(self):
        ...
        if it is hanging.
        """
        logging.info(f"Registering heartbeat for step {self._heartbeat_counter.value}.")
    ...
    def check_heartbeat(self) -> bool:
        ...
        if self._heartbeat_counter.value == 0:
            logging.info("Initial heartbeat not yet registered.")
            return True
    ...
    def set_complete(self):
        ...
        logging.info("Registering completion signal.")
...
class WorkloadWrapper:
    ...
    def __init__(self, workload: Callable, signals: _WorkloadSignals):
        ...
        Args:
            ...
            intercepts: The WorkloadIntercepts object housing user workload intercepts.
        """
    ...
    def __call__(self, *args: Sequence[Any], **kwargs: Mapping[str, Any]):
        ...
        logging.info("Wrapping workload with elastic workload decorator.")
        try:
            logging.info("Starting elastic workload.")
