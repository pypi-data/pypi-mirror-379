...
class BaseSimulator(abc.ABC):
    ...
    This class provides a common interface for different types of failure simulators.
    Concrete simulators should inherit from this class and implement the abstract methods.
    """

    def __init__(
        self, rank: int, gpu_world_size: int, gpus_per_node: int = 8, seed: int = 42
    ):
    ...
    def local_to_global_ranks(self, local_ranks: list[int]) -> list[int]:
        ...
        Returns:
            list[int]: A list of global ranks corresponding to the input local ranks.
        """
        global_ranks = [rank + (self.rank * self.gpus_per_node) for rank in local_ranks]
        return global_ranks
    ...
    def simulate(
        ...
        **kwargs,
        ...
        This method defines the main loop for the simulation and should be implemented
        by concrete simulators to define the specific failure simulation logic.
        """
        pass
    ...
    def induce_event(self, *args, **kwargs):
        ...
        This method defines a mechanism to manually induce a failure event and should be
        implemented by concrete simulators to define the specific failure event logic.
        """
        pass
