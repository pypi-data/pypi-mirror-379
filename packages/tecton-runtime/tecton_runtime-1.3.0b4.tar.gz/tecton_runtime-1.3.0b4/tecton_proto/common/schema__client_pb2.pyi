...
class Column(_message.Message):
    __slots__ = ["name", "offline_data_type", "feature_server_data_type", "raw_spark_type", "raw_snowflake_type", "feature_server_type"]
...
class OnlineBatchTablePart(_message.Message):
    __slots__ = ["window_index", "time_window", "schema", "tiles"]
...
class OnlineBatchTablePartTile(_message.Message):
    __slots__ = ["relative_start_time_inclusive", "relative_end_time_exclusive"]
