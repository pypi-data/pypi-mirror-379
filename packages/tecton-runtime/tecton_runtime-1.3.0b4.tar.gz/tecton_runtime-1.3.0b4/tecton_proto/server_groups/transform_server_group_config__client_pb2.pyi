...
class TransformServerGroupConfiguration(_message.Message):
    __slots__ = ["server_group_id", "workspace", "workspace_state_id", "secrets_config", "resource_providers_config", "transformations", "computed_time"]
...
class TransformServerGroupSecretsConfig(_message.Message):
    __slots__ = ["service_account_secret_name", "service_account_key_last_updated", "all_secrets_metadata", "feature_view_secret_references"]
...
class TransformServerResourceProviderConfig(_message.Message):
    __slots__ = ["feature_view_resource_providers", "all_resource_providers_metadata"]
...
class SecretMetadata(_message.Message):
    __slots__ = ["secret_reference", "last_updated"]
...
class TransformationOperation(_message.Message):
    __slots__ = ["transformation_id", "transformation_mode", "user_defined_function", "is_post_processor_operation"]
