...
class CreateModelArtifactRequest(_message.Message):
    __slots__ = ["name", "type", "description", "file_hashes", "input_schema", "output_schema", "tags", "model_file_path", "model_config_file_path", "artifact_files", "environments"]
...
class GetModelArtifactUploadUrlResponse(_message.Message):
    __slots__ = ["model_artifact_id", "upload_id", "model_config_upload_url"]
    MODEL_ARTIFACT_ID_FIELD_NUMBER: _ClassVar[int]
...
class CompleteModelArtifactUploadRequest(_message.Message):
    __slots__ = ["model_artifact_id", "upload_id", "part_etags"]
...
class UpdateTectonModelRequest(_message.Message):
    __slots__ = ["name", "id", "type", "description", "input_schema", "output_schema", "tags", "model_file_path", "model_config_file_path", "artifact_files", "environments"]
    class TagsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
