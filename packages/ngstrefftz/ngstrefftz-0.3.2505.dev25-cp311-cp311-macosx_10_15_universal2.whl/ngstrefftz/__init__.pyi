...
class TrefftzEmbedding:
    ...
    def GetParticularSolution(self, arg0: ngsolve.la.BaseVector) -> ngsolve.la.BaseVector:
        ...
        """
    def __init__(self, top: ngsolve.comp.SumOfIntegrals = None, trhs: ngsolve.comp.SumOfIntegrals = None, cop: ngsolve.comp.SumOfIntegrals = None, crhs: ngsolve.comp.SumOfIntegrals = None, ndof_trefftz: int = 0, eps: float = 0.0, fes: ngsolve.comp.FESpace = None, fes_test: ngsolve.comp.FESpace = None, fes_conformity: ngsolve.comp.FESpace = None, fes_ip: ngsolve.comp.SumOfIntegrals = None, ignoredofs: pyngcore.pyngcore.BitArray = None, stats: dict | None = None, check_conformity: float = 0.0) -> None:
        """
