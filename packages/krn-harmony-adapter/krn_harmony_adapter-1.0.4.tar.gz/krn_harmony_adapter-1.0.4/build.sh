...
RELEASE_PYPI_TOKEN="pypi-AgEIcHlwaS5vcmcCJDI4YTBlYmIzLTM5MmItNGU3OS05YTAzLTZjZTIxZTM4NTk3ZAACG1sxLFsia3JuLWhhcm1vbnktYWRhcHRlciJdXQACLFsyLFsiYjUwNDc5ZjktMDZkZC00MGE4LThkNGEtNWM1NzQwNTFiZmU0Il1dAAAGINQGirQ1I8wH0VVSc9IZ_2HtrTyxMGMSD6PRaPhJ1UBQ"
...
if [ "$RELEASE_MODE" = true ]; then
    ...
    echo ""
    echo "🚀 正式版安装方法："
    echo "pip install --no-cache-dir --force-reinstall krn-harmony-adapter"
else
    echo "📤 发布到Test PyPI："
