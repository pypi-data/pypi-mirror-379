...
RELEASE_PYPI_TOKEN="pypi-AgEIcHlwaS5vcmcCJGYwYmVkNTcyLTU3ZDgtNDE0ZS04YTc5LWMwODBlZjA4MmI0NQACKlszLCIwZTQxOWYzYi0zYTVkLTQzMDMtOTQ5OC01M2NiMzI1YWYwZGQiXQAABiD4YTn9U51RIYlLmlZwy6zoWhyqFe_0sUsi9mw2pybBHQ"
...
if [ "$RELEASE_MODE" = true ]; then
    ...
    echo ""
    echo "🚀 正式版安装方法："
    echo "pip install krn-harmony-adapter"
else
    echo "📤 发布到Test PyPI："
