...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    try:
        ...
        if make_opt == -1:   
            ...
            beos_make   = [os.path.join(__mcd_core_path,"include",Utility.GetPlatform(),__arch,"beos"), 
                                        os.path.join(__mcd_core_path,"lib",Utility.GetPlatform(),__arch)]         
            main(BuildID, files=VTL.GetSourceCode(2), source=beos_source, include=[], make=beos_make, libs=[])
