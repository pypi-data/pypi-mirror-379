...
@pytest.mark.parametrize(
    "scan_info, expected_npt_azim",
    [
        ({"type": "fscan", "save": True}, 360),
        ({"type": "oscan", "save": True}, 1),
    ],
)
def test_get_integration_options_parametrized(mock_bliss, scan_info, expected_npt_azim):
    ...
    assert result["npt_azim"] == expected_npt_azim
