from tianxiadatong_wx_robot.wxauto.utils.tools import (
    get_file_dir,
)
...
from tianxiadatong_wx_robot.wxauto.utils.win32 import (
    ReadClipboardData,
    SetClipboardText,
)
from .base import *
    ...
    def download(
        ...
        while True:
            ...
            if time.time() - t0 > timeout:
                return WxResponse.failure(f'下载超时: {self.type}'),None
            time.sleep(1)
