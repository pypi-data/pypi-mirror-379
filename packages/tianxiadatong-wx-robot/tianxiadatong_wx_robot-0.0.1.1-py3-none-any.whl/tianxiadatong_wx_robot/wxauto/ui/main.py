...
from tianxiadatong_wx_robot.wxauto.param import WxResponse
...
class WeChatSubWnd(BaseUISubWnd):
    ...
    def send_msg_at_all(
        ...
        return self._get_chatbox(who, False).send_msg_at_all(msg)
...
class WeChatMainWnd(WeChatSubWnd):
    ...
    def _setup_ui(self, hwnd: int):
        ...
        # print("---")
        # print(MainControl2.GetChildren())
        # print("---")
