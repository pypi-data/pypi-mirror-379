...
from src.tags_plot import plot_mesh_tags
...
with XDMFFile(mesh.comm, os.path.join(mesh_path, "square_quad.xdmf"), "w") as of:
    of.write_mesh(mesh)
...
with XDMFFile(MPI.COMM_WORLD, os.path.join(mesh_path, "square_quad.xdmf"), "r") as fi:
    mesh = fi.read_mesh()
...
plt.savefig("cells_tags_square_quad.png", dpi=500, bbox_inches="tight")
...
plt.savefig("facets_tags_square_quad.png", dpi=500, bbox_inches="tight")
