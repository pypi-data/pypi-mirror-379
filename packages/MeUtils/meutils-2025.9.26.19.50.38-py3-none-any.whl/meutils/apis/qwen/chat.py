...
class Completions(object):
    ...
    async def create(self, request: CompletionRequest, cookie: Optional[str] = None):
        ...
        model = request.model if not request.model.startswith("qwen-image") else DEFAUL_MODEL
        payload = {
            "chat_id": chat_id,
            ...
            "messages": [  # todo 多轮对话
                {
                    ...
                    "feature_config": {
                        "thinking_enabled": request.enable_thinking or False,  # 这个参数是否足够判断 enable_thinking
                        "output_schema": "phase",
