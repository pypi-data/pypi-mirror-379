...
def main():
    ...
    if 'app_initialized' not in st.session_state:
        ...
        st.session_state.scraper_process = None # MODIFICATION: Changed from 'pid' to 'scraper_process'
    ...
    with st.container(border=True):
        ...
        if not basic_mode:
            with st.expander("🛠️ Advanced Settings"):
                ...
                # ... (rest of the proxy settings UI remains unchanged)
                st.markdown("---")
    ...
    # --- Results display logic remains unchanged ---
    if st.session_state.results is not None and not st.session_state.results.empty:
        ...
        with results_placeholder.container():
            ...
            st.markdown("---")
            # ... (download buttons logic remains unchanged)
            if basic_mode:
    ...
    if st.session_state.start_job:
        ...
        # ... (logging and proxy setup remains unchanged)
        ...
        p.start()
        st.session_state.scraper_process = p # MODIFICATION: Store the whole process object
        st.session_state.start_job = False
        st.rerun()
    ...
    if st.session_state.searching:
        ...
        # ... (Queue reading logic remains unchanged)
        try:
            while True:
        ...
        # --- MODIFICATION: New, more reliable process completion check ---
