...
class TestFilterSimilarHD(unittest.TestCase):
    ...
    def test_n_one(self):
        ...
        result = ere.filter_similar_hd(sequences, 1, case_sensitive=True)
    ...
    def test_n_two(self):
        ...
        result = ere.filter_similar_hd(sequences, 2, case_sensitive=True)
    ...
    def test_hamming_dist_kws_are_passed(self):
        ...
        """
        sequences = "abc", "ade"
        result = ere.filter_similar_hd(sequences, 1, ignore="D", case_sensitive=True)
    ...
    def test_case_insensitive(self):
        """
        Test case_sensitive=False flag works correctly for filter_similar_hd.
        """
        sequences = ["ABC", "abc"]
        result = ere.filter_similar_hd(sequences, 1, case_sensitive=False)
        self.assertEqual(1, len(result))

    def test_case_sensitive(self):
        """
        Test case_sensitive=True flag works correctly for filter_similar_hd.
        """
        sequences = ["ABC", "abc"]
        result = ere.filter_similar_hd(sequences, 1, case_sensitive=True)
    ...
    def test_mixed_case(self):
        """
        Test mixed case scenario for filter_similar_hd.
        """
        sequences = ["ABC", "abC", "ABc"]
        result = ere.filter_similar_hd(sequences, 1, case_sensitive=False)
        self.assertEqual(1, len(result))
...
class TestLoadFasta(unittest.TestCase):
    ...
    def test_translate_nt(self):
        ...
        self.assertEqual(expected, ere.load_fasta(self.fasta_path, translate_nt=True))
    ...
    def test_convert_to_upper(self):
        ...
        expected = {"seq1": "ATGC", "seq2": "TT-A"}
        self.assertEqual(
            expected, ere.load_fasta(self.fasta_path, convert_to_upper=True)
        )
