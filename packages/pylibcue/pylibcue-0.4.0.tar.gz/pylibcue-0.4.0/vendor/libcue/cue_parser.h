...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    DATE = 300,                    /* DATE  */
    COMMENT = 301,                 /* COMMENT  */
    XXX_GENRE = 302,               /* XXX_GENRE  */
    XXX_DISCID = 303,              /* XXX_DISCID  */
    XXX_COMPOSER = 304,            /* XXX_COMPOSER  */
    REPLAYGAIN_ALBUM_GAIN = 305,   /* REPLAYGAIN_ALBUM_GAIN  */
    REPLAYGAIN_ALBUM_PEAK = 306,   /* REPLAYGAIN_ALBUM_PEAK  */
    REPLAYGAIN_TRACK_GAIN = 307,   /* REPLAYGAIN_TRACK_GAIN  */
    REPLAYGAIN_TRACK_PEAK = 308    /* REPLAYGAIN_TRACK_PEAK  */
  };
