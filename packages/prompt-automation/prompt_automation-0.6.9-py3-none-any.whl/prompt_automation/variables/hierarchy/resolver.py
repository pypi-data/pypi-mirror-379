...
class StubEspansoDiscoveryAdapter:
    ...
    filesystem probing. Real adapters can implement the same interface and be
    injected when wiring the production Espanso sync.
    """

    def collect(self) -> Mapping[str, Any]:
        return {
            "__espanso__": {
                "match_files": ["packages/prompt-automation/0.1.42/match/base.yml"],
