            ...
            **strip_not_given(
                {
                    ...
                    "X-Nullable-Integer": str(x_nullable_integer) if is_given(x_nullable_integer) else omit,
                    "X-Optional-Boolean": ("true" if x_optional_boolean else "false")
                    if is_given(x_optional_boolean)
                    else omit,
                    "X-Optional-Integer": str(x_optional_integer) if is_given(x_optional_integer) else omit,
                    "X-Optional-Number": str(x_optional_number) if is_given(x_optional_number) else omit,
