...
class TestChecksumIntegration:
    ...
    def test_checksum_calculate_json_output(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "checksum", "calculate", "test"] # type: ignore
        )
    ...
    def test_checksum_validate_valid_checksum(self):
        ...
        # Then validate it
        result = self.runner.invoke(cli, ["telegram", "checksum", "validate", "test", checksum]) # type: ignore
    ...
    def test_checksum_validate_invalid_checksum(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "validate", "test", "XX"]) # type: ignore
    ...
    def test_checksum_validate_crc32_algorithm(self):
        ...
        # Then validate it
        result = self.runner.invoke(
            cli, ["telegram", "checksum", "validate", "test", checksum, "--algorithm", "crc32"] # type: ignore
        )
    ...
    def test_checksum_validate_json_output(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "checksum", "validate", "test", "XX"] # type: ignore
        )
    ...
    def test_checksum_help_command(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "--help"]) # type: ignore
    ...
    def test_checksum_calculate_help(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "calculate", "--help"]) # type: ignore
    ...
    def test_checksum_validate_help(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "validate", "--help"]) # type: ignore
    ...
    def test_checksum_calculate_empty_string(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "calculate"]) # type: ignore
    ...
    def test_checksum_validate_empty_string(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "validate", "", "AA"]) # type: ignore
    ...
    def test_algorithm_parameter_validation(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "checksum", "calculate", "test", "--algorithm", "invalid"] # type: ignore
        )
    ...
    def test_missing_arguments(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "validate", "test"]) # type: ignore
        assert result.exit_code != 0
    ...
    def test_checksum_calculate_various_data(self, test_data):
        ...
        result = self.runner.invoke(cli, ["telegram", "checksum", "calculate", test_data]) # type: ignore
    ...
    def test_error_handling_json_format(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "checksum", "validate", "test", "invalid"] # type: ignore
        )
