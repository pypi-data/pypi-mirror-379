...
class TestHomekitModuleServiceIntegration:
    ...
    def test_on_accessory_get_on_integration(self, mock_telegram_service, mock_cache_service):
        ...
        try:
            ...
            mock_telegram_instance.parse_status_response.return_value = {1: True, 2: False, 3: True}
            ...
            mock_telegram_instance.parse_status_response.assert_called_once_with("test_telegram_data")
