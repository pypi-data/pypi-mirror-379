...
class TruoraCreditScoreCompanySchema(BaseModel):
    ...
    dataset_credit_history: float = Field(default=0.5, description="dataset_credit_history")
    dataset_business_background: float = Field(default=0.5, description="dataset_business_background")
    #dataset_legal_background: float = Field(default=0.2, description="dataset_legal_background")
...
class TruoraCreditScorePersonSchema(BaseModel):
    ...
    dataset_credit_history: float = Field(default=0.5, description="dataset_credit_history")
    dataset_personal_identity: float = Field(default=0.5, description="dataset_personal_identity")
    #dataset_legal_background: float = Field(default=0.2, description="dataset_legal_background")
