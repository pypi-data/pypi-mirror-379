...
AZURE_STORAGE_CONN_STR = config.get("AZURE_STORAGE_CONNECTION_STRING")
DATALAKE_CONTAINER = config.get("FDC_DATA_LAKE_CONTAINER")
...
class BlobFileHandler:
    ...
    def __init__(self):
        ...
        """
        self.blob_service_client = BlobServiceClient.from_connection_string(AZURE_STORAGE_CONN_STR)
        self.container = DATALAKE_CONTAINER
