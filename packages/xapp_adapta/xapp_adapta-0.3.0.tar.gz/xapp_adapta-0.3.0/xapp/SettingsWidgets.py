...
class SettingsPage(Gtk.Box):
    ...
    def add_reveal_section(
        self, title, schema=None, key=None, values=None, revealer=None
    ):
...
class SettingsSection(Gtk.Box):
    ...
    def add_reveal_row(
        self, widget, schema=None, key=None, values=None, check_func=None, revealer=None
    ):
        vbox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        if self.need_separator:
            vbox.add(Gtk.Separator(orientation=Gtk.Orientation.HORIZONTAL))
        ...
        if not self.always_show:
            revealer.notify_id = revealer.connect(
                "notify::child-revealed", self.check_reveal_state
            )
...
class Entry(SettingsWidget):
    ...
    def __init__(
        self, label, expand_width=False, size_group=None, dep_key=None, tooltip=""
    ):
...
class FontButton(SettingsWidget):
    ...
    def __init__(
        self,
        label,
        level=(Gtk.FontChooserLevel.STYLE | Gtk.FontChooserLevel.SIZE),
        size_group=None,
        dep_key=None,
        tooltip="",
    ):
...
class Range(SettingsWidget):
    ...
    def __init__(
        ...
        if invert:
            self.step *= (
                -1
            )  # Gtk.Scale.new_with_range want a positive value, but our custom scroll handler wants a negative value
...
class ColorChooser(SettingsWidget):
    ...
    def __init__(
        self, label, legacy_string=False, size_group=None, dep_key=None, tooltip=""
    ):
...
class FileChooser(SettingsWidget):
    ...
    def __init__(
        self, label, dir_select=False, size_group=None, dep_key=None, tooltip=""
    ):
...
class Text(SettingsWidget):
    def __init__(self, label, align=Gtk.Align.START):
        ...
        self.content_widget = Gtk.Label(
            label, halign=align, xalign=xalign, justify=justification
        )
