...
#[pyfunction]
fn sy_driftingmean50_min_f(y: Vec<f64>) -> f64 {
    sy_driftingmean50_min(&y)
}

#[pyfunction]
fn sy_slidingwindow_f(y: Vec<f64>, window_stat: &str, across_win_stat: &str, num_seg: usize, inc_move: usize) -> f64 {
    sy_slidingwindow(&y, window_stat, across_win_stat, num_seg, inc_move)
}

#[pyfunction]
fn st_localextrema_n100_diffmaxabsmin_f(y: Vec<f64>) -> f64 {
