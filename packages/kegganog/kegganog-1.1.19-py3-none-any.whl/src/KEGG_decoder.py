...
'''
Great kudos to the OG author of the script! https://github.com/bjtully/BioData/blob/master/KEGGDecoder/README.md
In previous versions of KEGGaNOG I used KEGG-Decoder as the dependecy.
But it made me use Python 3.6 which is not good by the end of 2024 year...
To make my tool use actual version of Python I had to take one of KEGG-Decoder's scripts and use it as is
When I write this KEGGaNOG uses Python 3.13.1! And all the new versions of pandas, matplotlib, seaborn etc.
