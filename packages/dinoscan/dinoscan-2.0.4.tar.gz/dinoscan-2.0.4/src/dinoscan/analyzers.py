...
class SnakeCaseNodeVisitor(ast.NodeVisitor):
    """An AST visitor that maps CamelCase node names to snake_case methods."""

    def visit(self, node: ast.AST):  # type: ignore[override]
        method_name = f"visit_{_camel_to_snake(node.__class__.__name__)}"
...
class SecurityAnalyzer(BaseAnalyzer):
    ...
    def analyze(
        ...
        class SecurityVisitor(SnakeCaseNodeVisitor):
...
class DeadCodeAnalyzer(BaseAnalyzer):
    ...
    def analyze(
        ...
        class DefinitionVisitor(SnakeCaseNodeVisitor):
            """
        ...
        class UsageVisitor(SnakeCaseNodeVisitor):
...
class CircularImportAnalyzer(BaseAnalyzer):
    ...
    def analyze(
        ...
        class ImportVisitor(SnakeCaseNodeVisitor):
            ...
            def visit_import_from(self, node):
                """Visit from-import statements and record potential circular imports."""
...
class DuplicateAnalyzer(BaseAnalyzer):
    ...
    def analyze(
        ...
        class FunctionVisitor(SnakeCaseNodeVisitor):
...
class DocsAnalyzer(BaseAnalyzer):
    ...
    def analyze(
        ...
        class DocstringVisitor(SnakeCaseNodeVisitor):
