...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60772);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(94477),
    __webpack_require__(81876),
    __webpack_require__(26659),
    __webpack_require__(56019),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(81168),
  __webpack_require__(26440),
  __webpack_require__(75701),
  __webpack_require__(77763),
  __webpack_require__(32168),
  __webpack_require__(22361),
  __webpack_require__(71712),
  
      (__webpack_require__(66792)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(66847)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(30623),
  __webpack_require__(21952),
  
      (__webpack_require__(67583)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(18113)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(43216)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(7228)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(20487)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(70792)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(52509)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(226),
  __webpack_require__(24340),
  __webpack_require__(56282),
  __webpack_require__(22030),
  
      (__webpack_require__(93713)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(70482),
  __webpack_require__(28159),
  __webpack_require__(35754),
  
      (__webpack_require__(27282)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(65306),
  __webpack_require__(70781),
  __webpack_require__(48939),
  __webpack_require__(76113),
  __webpack_require__(71454),
  __webpack_require__(26050),
  __webpack_require__(75099),
  __webpack_require__(66975),
  __webpack_require__(78081),
  __webpack_require__(75839),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(51771)["default"].filter)(({id}) => [
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(36533),
  __webpack_require__(75795),
  
      (__webpack_require__(78371)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(46699)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(93682)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(26893).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(6562).IServiceManager);
...
//# sourceMappingURL=8781.4eec0073705de68f6387.js.map?v=4eec0073705de68f6387