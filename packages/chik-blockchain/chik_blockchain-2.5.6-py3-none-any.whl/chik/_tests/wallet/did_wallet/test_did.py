...
from chik.wallet.wallet_request_types import DIDFindLostDID, DIDGetCurrentCoinInfo, DIDGetInfo, DIDGetRecoveryInfo
...
async def make_did_wallet(
    ...
    if use_alternate_recovery:
        with pytest.MonkeyPatch.context() as m:
            m.setattr("chik.wallet.did_wallet.did_wallet_puzzles.create_innerpuz", alt_create_innerpuz)
