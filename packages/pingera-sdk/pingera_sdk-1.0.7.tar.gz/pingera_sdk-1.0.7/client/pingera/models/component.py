...
class Component(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["only_show_if_degraded", "start_date", "updated_at", "name", "status", "description", "created_at", "group_id", "group", "showcase", "position", "page_id", "id"]
