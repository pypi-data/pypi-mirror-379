...
class AlertRule1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["condition_parameters", "auto_resolve", "condition", "severity", "enabled", "cooldown_period", "name", "channel_ids", "created_at", "check_id", "updated_at", "check_name", "channels", "id"]
