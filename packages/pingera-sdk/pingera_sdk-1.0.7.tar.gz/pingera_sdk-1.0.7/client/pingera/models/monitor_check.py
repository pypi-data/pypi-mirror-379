...
class MonitorCheck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["last_checked_at", "secrets", "updated_at", "active", "port", "status", "host", "url", "timeout", "parameters", "interval", "id", "name", "created_at", "group_id", "group", "position", "type"]
