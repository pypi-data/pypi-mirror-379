...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["recent_pings", "grace_seconds", "updated_at", "next_expected_ping", "name", "status", "created_at", "last_ping_at", "period_seconds", "ping_url", "id", "active"]
