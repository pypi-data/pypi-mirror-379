...
from src.core.context_assembly import list_datasets, assemble_context  
from src.core.utils import dynamic_docstring
...
def register_tools(mcp):
    ...
    def execute_query(
        ...
        """
        from src.connectors.snowflake import SnowflakeDB
