...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "content_guard", "prn", "no_content_change_since", "pulp_labels", "base_url", "pulp_last_updated", "hidden", "pulp_created", "pulp_href", "name"]
