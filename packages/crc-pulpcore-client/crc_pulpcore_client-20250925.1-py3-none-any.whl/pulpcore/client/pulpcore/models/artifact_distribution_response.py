...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "no_content_change_since", "pulp_href", "base_url", "pulp_last_updated", "pulp_created", "pulp_labels", "content_guard", "hidden", "base_path", "prn"]
