...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "no_content_change_since", "content_guard", "pulp_labels", "pulp_created", "hidden", "prn", "pulp_href", "base_url", "pulp_last_updated", "name"]
