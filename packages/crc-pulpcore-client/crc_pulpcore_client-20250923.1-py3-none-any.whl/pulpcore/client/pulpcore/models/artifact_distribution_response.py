...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "base_path", "pulp_last_updated", "pulp_created", "hidden", "name", "prn", "base_url", "no_content_change_since", "pulp_href", "pulp_labels"]
