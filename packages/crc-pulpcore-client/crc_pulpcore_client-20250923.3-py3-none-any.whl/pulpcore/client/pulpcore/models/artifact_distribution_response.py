...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "hidden", "base_url", "no_content_change_since", "content_guard", "prn", "pulp_last_updated", "pulp_labels", "base_path", "pulp_created", "name"]
