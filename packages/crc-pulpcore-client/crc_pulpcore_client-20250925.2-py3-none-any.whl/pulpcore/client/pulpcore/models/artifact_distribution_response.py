...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "pulp_href", "pulp_labels", "base_path", "pulp_created", "content_guard", "no_content_change_since", "hidden", "name", "base_url", "pulp_last_updated"]
