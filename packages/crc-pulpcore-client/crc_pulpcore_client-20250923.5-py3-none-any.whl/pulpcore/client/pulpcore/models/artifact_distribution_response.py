...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "name", "pulp_last_updated", "no_content_change_since", "pulp_href", "hidden", "pulp_labels", "base_url", "base_path", "prn", "pulp_created"]
