[![PyPI](https://img.shields.io/pypi/v/mcgt-core.svg)](https://pypi.org/project/mcgt-core/)
[![Python](https://img.shields.io/pypi/pyversions/mcgt-core.svg)](https://pypi.org/project/mcgt-core/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![CI](https://github.com/git@github.com:JeanPhilipLalumiere/MCGT.git/actions/workflows/publish.yml/badge.svg)](https://github.com/git@github.com:JeanPhilipLalumiere/MCGT.git/actions/workflows/publish.yml)
