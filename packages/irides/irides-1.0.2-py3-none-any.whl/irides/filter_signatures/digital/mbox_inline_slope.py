...
Digital mbox inline slope-filter signature.
...
from irides.filter_signatures.digital import mbox_level as fsig_dig_l_mbox
...
def generate_impulse_response(
    ...
    """Creates a DT impulse response for the mbox inline slope filter.
    ...
    ds = fsig_dig_l_mbox.generate_impulse_response(
