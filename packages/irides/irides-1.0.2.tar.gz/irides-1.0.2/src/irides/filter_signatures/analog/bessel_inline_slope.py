...
Analog Bessel inline slope filter:
...
from irides.design.analog import bessel_inline_slope as design
...
def generate_impulse_response(
    ...
    r"""
    Creates a continuous-time-like impulse response for the this
    inline slope filter. The implementation starts with a temporally scaled
    reference impulse response and then takes the causal first
    difference.
