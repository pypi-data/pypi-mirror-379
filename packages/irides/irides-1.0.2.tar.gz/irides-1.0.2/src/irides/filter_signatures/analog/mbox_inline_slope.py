...
Analog box multistage inline slope filter:
...
from irides.design.analog import mbox_inline_slope as design

from irides.filter_signatures.analog import mbox_level as f_sig_ref
...
def generate_impulse_response(
    ...
    The implementation starts with a temporally scaled reference impulse
    response and then takes the causal first difference.

    Only orders [2..8] are implemented.
    ...
    # start with a reference-filter impulse response
