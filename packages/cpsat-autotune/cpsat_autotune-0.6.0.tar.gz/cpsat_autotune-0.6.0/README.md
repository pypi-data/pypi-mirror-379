...
> [!WARNING]
>
> This project is highly experimental and is developed on low priority.
...
- **0.6.0** Using the parameters suggested in [CPMPy](https://cpmpy.readthedocs.io/en/latest/_modules/cpmpy/solvers/ortools.html#CPM_ortools.tunable_params) as default.
