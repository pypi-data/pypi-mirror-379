...
class JoinCodeInvite302ResponseSettings(BaseModel):
    ...
    screener_questions: Optional[List[ScreenerQuestionChooseOnePublic]] = Field(default=None, alias="screenerQuestions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "screenerQuestions": [ScreenerQuestionChooseOnePublic.from_dict(_item) for _item in obj["screenerQuestions"]] if obj.get("screenerQuestions") is not None else None,
