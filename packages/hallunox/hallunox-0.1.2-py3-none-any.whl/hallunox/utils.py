...
def format_confidence_report(results: dict) -> str:
    ...
    report.append(f"   Medium Confidence (0.6-0.8): {summary.get('medium_confidence_count', 0)}")
    report.append(f"   Low Confidence (0.4-0.6): {summary.get('low_confidence_count', 0)}")
