...
New function: isimported("module"). Checks if
"module" is currently imported into Python Shell
(Not Pythonlib)

Help text (see below)
Now has outcomes after the functions 
instead of being function after function
and being very bland
---
...
modx.import_all()
# Output: (Imports 250+ standard library modules silently)
