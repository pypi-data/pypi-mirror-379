...
Minor update: Performance Update
Fixed many bugs including SyntaxErrors, 
ImportErrors, etc.
Reworked importing functions to work
a little bit faster.
Upgraded isimported() functionality
WAYYYYYY more modules added into
modules master list---
