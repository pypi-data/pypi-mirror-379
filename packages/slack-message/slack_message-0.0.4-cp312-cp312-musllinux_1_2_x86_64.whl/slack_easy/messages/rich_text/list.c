...
{
    "distutils": {
        "name": "slack_easy.messages.rich_text.list",
        "sources": [
            "src/slack_easy/messages/rich_text/list.py"
        ]
    },
    "module_name": "slack_easy.messages.rich_text.list"
}
END: Cython Metadata */
...
#define __PYX_HAVE__slack_easy__messages__rich_text__list
#define __PYX_HAVE_API__slack_easy__messages__rich_text__list
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "slack_easy.messages.rich_text.list" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "slack_easy.messages.rich_text.list"
extern int __pyx_module_is_main_slack_easy__messages__rich_text__list;
int __pyx_module_is_main_slack_easy__messages__rich_text__list = 0;

/* Implementation of "slack_easy.messages.rich_text.list" */
...
__Pyx_RefNannySetupContext("PyInit_list", 0);
  ...
  if (__pyx_module_is_main_slack_easy__messages__rich_text__list) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "slack_easy.messages.rich_text.list")) {
      if (unlikely((PyDict_SetItemString(modules, "slack_easy.messages.rich_text.list", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "slack_easy/messages/rich_text/list.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init slack_easy.messages.rich_text.list", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init slack_easy.messages.rich_text.list");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
