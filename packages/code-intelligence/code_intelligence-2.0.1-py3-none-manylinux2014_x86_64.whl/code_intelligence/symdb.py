...
_lib.enqueue_find_references.argtypes = [ctypes.c_char_p]
...
class AsyncSymbolDatabase:
    ...
    def async_find_references(self, symbol_name: str) -> int:
        """Asynchronously find symbol references. Returns request ID."""
        return _lib.enqueue_find_references(symbol_name.encode("utf-8"))
