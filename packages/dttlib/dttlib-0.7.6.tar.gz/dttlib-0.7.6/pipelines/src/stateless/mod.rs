...
use crate::{
    ConfigData, PIPELINE_SIZE, PipeData, PipeOut, PipeResult, PipelineBase, PipelineOutput,
    PipelineReceiver, PipelineSender, PipelineSubscriber,
};
    ...
    G: Stateless2Gen<I, H, A, B, T, C>,
{
    ...
    pub async fn create(
        ...
        p.run(
            rc.ump_clone(),
            input_sub1.subscribe_or_die(rc.ump_clone()).await,
