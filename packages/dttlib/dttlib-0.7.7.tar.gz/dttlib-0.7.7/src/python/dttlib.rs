...
use crate::params::channel_params::{
    Channel, ChannelId, ChannelParams, ChannelSettings, ChannelSettingsParams, ChannelType,
    NDSDataType, TrendStat, TrendType,
};
...
use crate::{AnalysisID, default_fft_params};
