...
**SIF航线规划器 - v1.1.0简化版 + GitHub Actions自动发布**

这是基于v1.1.0版本的稳定简化航线规划器，专为SIF（Solar-Induced Fluorescence）单点光谱设备优化。项目回退到388行的简洁代码，专注稳定性和性能，并添加了基于标签推送的自动发布功能。

**当前状态**: 已删除v1.1.0之后的所有标签和提交，回到干净的v1.1.0基础上添加GitHub Actions自动发布功能
