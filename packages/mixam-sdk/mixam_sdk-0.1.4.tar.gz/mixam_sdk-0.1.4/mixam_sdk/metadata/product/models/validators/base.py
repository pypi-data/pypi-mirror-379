...
class DefaultComponentValidator:
    ...
    def validate(self, productMetadata: ProductMetadata, itemSpecification: ItemSpecification, component: ComponentSupport, result: ValidationResult, base_path: str) -> None:
        ...
        try:
            allowed_colours = {o.colours.name for o in productMetadata.colours_metadata.colours_options}
            ...
            # Be defensive; if metadata shape changes, don't crash the validator
            pass

        # Validate back colours for two-sided components
        try:
            if isinstance(component, ITwoSidedComponent):
                allowed_back_colours = {o.colours.name for o in productMetadata.colours_metadata.back_colours_options}
        ...
        try:
            allowed_formats = {s.format for s in productMetadata.standard_sizes}
        ...
        try:
            if component.substrate.design is not None:
                allowed_designs = {sd.substrate_design.name for sd in productMetadata.substrate_designs}
