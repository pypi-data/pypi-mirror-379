...
class ProductMetadata(BaseModel):
    ...
    def validate(self, spec: ItemSpecification) -> ValidationResult:
        ...
        # Provide a back-reference to the ItemSpecification for component validators that
        # need cross-component/product context (used by BoundComponentValidator etc.)
        try:
            setattr(result, "_spec", spec)
        except Exception:
            pass
