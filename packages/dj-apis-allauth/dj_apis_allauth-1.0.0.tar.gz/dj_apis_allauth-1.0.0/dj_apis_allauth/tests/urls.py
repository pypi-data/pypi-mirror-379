...
from dj_apis_allauth.registration.views import (
    SocialAccountDisconnectView, SocialAccountListView, SocialConnectView,
    SocialLoginView, RegisterView
)
from dj_apis_allauth.serializers import *
from dj_apis_allauth.social_serializers import (
    TwitterConnectSerializer, TwitterLoginSerializer,
)
from dj_apis_allauth.urls import urlpatterns

from . import django_urls


class ExampleProtectedView(GenericAPIView):
...
urlpatterns += [
    re_path(r'^rest-registration/', include('dj_api_auth.urls')),
