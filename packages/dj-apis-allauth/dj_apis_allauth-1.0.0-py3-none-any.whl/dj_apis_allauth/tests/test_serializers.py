...
from dj_apis_allauth.serializers import PasswordChangeSerializer, UserDetailsSerializer
from dj_apis_allauth.registration.serializers import SocialLoginSerializer
from dj_apis_allauth.registration.views import SocialLoginView
...
validator_path = 'dj_apis_allauth.tests.test_serializers.custom_username_validators'
