...
def solve(model, loading, output=None, algorithm=None, scale=1.0, constraints="Plain", operation=None, test=None):
    """
    ...
    """
    analysis = StaticAnalysis(loading, algorithm=algorithm, test=test)
