        ...
        async def wrapper(*args, **kwargs):
            ...
            with tracer.start_as_current_span(f"GraphQL.{operation_name}") as span:
                ...
                try:
                    ...
                    # Log in to Application Insights
                    ...
                    # Span attributes
                    span.set_attribute('graphql.operationName', operation_name)
                    span.set_attribute('graphql.status', response.get('status'))
                    span.set_attribute('graphql.message', response.get('message'))
                    span.set_attribute('graphql.duration_ms', duration)
                    ...
                    span.record_exception(ex)  # log exception in trace
