    ...
    async def _discover_services(self) -> None:
        ...
        try:
            ...
            services = self.service_discovery.find_multiple_services(
                base_url=self.discovery_url, avatar_id=self.avatar_id, count=self.max_retry_attempts, env=self.env
            )
...
async def create_client(
    ...
    **kwargs,
    ...
    """
    client = StreamingAvatarClient(api_key=api_key, avatar_id=avatar_id, discovery_url=discovery_url, env=env, **kwargs)
