...
The SDK supports different environment configurations through the `env` parameter:
...
```
- **Service Discovery URL**: `/streamingAvatar/service_status?group_name=WEBSOCKET_GROUP_TEST`
...
```
- **Service Discovery URL**: `/streamingAvatar/service_status`
- **Use Case**: Production deployments

### Environment Parameter Details
- **Default**: `"test"` (for backward compatibility)
- **Valid Values**: `"test"` or `"prod"`
- **Test Environment**: Adds `group_name=WEBSOCKET_GROUP_TEST` parameter to service discovery
- **Production Environment**: Uses standard service discovery without additional parameters
...
- `env`: Environment parameter ("test" or "prod"), defaults to "test"
