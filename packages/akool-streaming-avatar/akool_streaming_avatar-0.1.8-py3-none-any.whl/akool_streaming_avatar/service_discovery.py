...
class ServiceDiscovery:
    ...
    def discover_services(
        self, base_url: str, avatar_id: Optional[str] = None, env: str = "test"
        ...
        # Add group_name parameter if env is "test"
        params = {}
        if env == "test":
            params["group_name"] = "WEBSOCKET_GROUP_TEST"

        headers = {"api_key": self.api_key, "Content-Type": "application/json"}

        try:
            logger.info(f"Discovering services from {url} with params: {params}")
    ...
    def find_available_service(
        self, base_url: str, avatar_id: Optional[str] = None, prefer_random: bool = True, env: str = "test"
        ...
        Raises:
            ...
            AuthenticationError: If authentication fails
        """
        instances = self.discover_services(base_url, avatar_id, env)
    ...
    def find_multiple_services(
        self, base_url: str, avatar_id: Optional[str] = None, count: int = 3, env: str = "test"
    ) -> List[ServiceInstance]:
        """
