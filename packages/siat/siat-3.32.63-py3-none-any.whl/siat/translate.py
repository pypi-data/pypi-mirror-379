...
def codetranslate1(code):
    ...
    codedict=pd.DataFrame([
        ...
        #期货==================================================================
        ["ZT=F",'2-Year US T-Note Futures'],
        ["ZF=F",'5-Year US T-Note Futures'],
        ["ZN=F",'10-Year US T-Note Futures'], 
        ["ZB=F",'30-Year US T-Bond Futures'],
        ...
        ["YM=F",'Mini Dow Jones Industrial Index Futures'],
        ...
        ["B0=F",'Mont Belvieu LDH Propane (OPIS) Futures'],
        ["ZC=F",'Corn Futures'],
        ["ZO=F",'Oat Futures'],
        ...
        ["ZM=F",'S&P Composite 1500 ESG Tilted Futures'],
        ["ZL=F",'Soybean Oil Futures'],
        ["ZS=F",'Soybean Futures'],
        
        # 为投资者提供国际（美国以外）高股息股票的收益与资本增值机会
        ["GF=F",'WisdomTree International High Dividend ETF'],
        ...
        ['USDCNY', '1 USD to RMB'], ['CNYUSD', '1 RMB to USD'],
        ['AUDCNY', '1 Australian Dollar to RMB'], ['CNYAUD', '1 RMB to Australian Dollar'],
        ['JPYCNY', '1 Japanese Yen to RMB'], ['CNYJPY', '1 RMB to Japanese Yen'],
        ['USDJPY', '1 USD to Japanese Yen'], ['JPYUSD', '1 Japanese Yen to USD'],
        ['SGDCNY', '1 Singapore Dollar to RMB'], ['CNYSGD', '1 RMB to Singapore Dollar'],
        ['SGDMYR', '1 Singapore Dollar to Malaysian Ringgit'], ['MYRSGD', '1 Malaysian Ringgit to Singapore Dollar'],
        ['EURCNY', '1 Euro to RMB'], ['CNYEUR', '1 RMB to Euro'],
        ['GBPCNY', '1 British Pound to RMB'], ['CNYGBP', '1 RMB to British Pound'],
        ['KRWCNY', '1 South Korean Won to RMB'], ['CNYKRW', '1 RMB to South Korean Won'],
        ['HKDCNY', '1 Hong Kong Dollar to RMB'], ['CNYHKD', '1 RMB to Hong Kong Dollar'],
        ['CADCNY', '1 Canadian Dollar to RMB'], ['CNYCAD', '1 RMB to Canadian Dollar'],
        ['INRCNY', '1 Indian Rupee to RMB'], ['CNYINR', '1 RMB to Indian Rupee'],
        ['RUBCNY', '1 Russian Ruble to RMB'], ['CNYRUB', '1 RMB to Russian Ruble'],
        ['MOPCNY', '1 Macau Pataca to RMB'], ['CNYMOP', '1 RMB to Macau Pataca'],

        ['AUDJPY', '1 Australian Dollar to Japanese Yen'],

        ['AUDUSD', '1 Australian Dollar to USD'],
        ['KRWUSD', '1 South Korean Won to USD'],
        ['HKDUSD', '1 Hong Kong Dollar to USD'],
        ['TWDUSD', '1 New Taiwan Dollar to USD'],
        ['PHPUSD', '1 Philippine Peso to USD'],
        ['IDRUSD', '1 Indonesian Rupiah to USD'],
        ['THBUSD', '1 Thai Baht to USD'],
        ['MYRUSD', '1 Malaysian Ringgit to USD'],
        ['SGDUSD', '1 Singapore Dollar to USD'],
        ['INRUSD', '1 Indian Rupee to USD'],
        ['AUDUSD', '1 Australian Dollar to USD'],
        ['NZDUSD', '1 New Zealand Dollar to USD'],
        ['TRYUSD', '1 Turkish Lira to USD'],
        ['ILSUSD', '新谢克尔兑美元汇率'],
        ['CADUSD', '1 Canadian Dollar to USD'],
        ['MXNUSD', '墨西哥比索兑美元汇率'],
        ['ARSUSD', '阿根廷比索兑美元汇率'],
        ['CLPUSD', '智利比索兑美元汇率'],
        ['BRLUSD', '巴西雷亚尔兑美元汇率'],
        ['EURUSD', '1 Euro to USD'],
        ['GBPUSD', '1 British Pound to USD'],
        ['CHFUSD', '瑞士法郎兑美元汇率'],
        ['HUFUSD', '匈牙利福林兑美元汇率'],
        ['SEKUSD', '瑞典克朗兑美元汇率'],
        ['DKKUSD', '丹麦克朗兑美元汇率'],
        ['NOKUSD', '挪威克朗兑美元汇率'],
        ['RUBUSD', '1 Russian Ruble to USD'],
        ['PLNUSD', '波兰兹罗提兑美元汇率'],
        ['RONUSD', '罗马尼亚列伊兑美元汇率'],
        ['BGNUSD', '保加利亚列弗兑美元汇率'],
        ['ZARUSD', '南非兰特兑美元汇率'],
