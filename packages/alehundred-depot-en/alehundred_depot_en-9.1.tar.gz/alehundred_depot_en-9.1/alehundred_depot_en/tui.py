...
class TUIController:
    ...
    def _show_scrolling_log(self, title, generator_func):
        ...
        if final_status == 'SUCCESS':
            ...
            self._show_dialog("Information", ["The server is already installed.", "If not running, press F2 on the main menu", "for instructions on how to restart it."])
