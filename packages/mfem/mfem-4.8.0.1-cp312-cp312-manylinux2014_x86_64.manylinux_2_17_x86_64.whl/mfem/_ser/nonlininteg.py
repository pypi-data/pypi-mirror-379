...
class NonlinearFormIntegrator(mfem._ser.integrator.Integrator):
...
class PyNonlinearFormIntegrator(NonlinearFormIntegrator):
    ...
    def GetDefaultIntegrationRule(self, trial_fe, test_fe, trans):
        r"""GetDefaultIntegrationRule(PyNonlinearFormIntegrator self, FiniteElement trial_fe, FiniteElement test_fe, ElementTransformation trans) -> IntegrationRule"""
        return _nonlininteg.PyNonlinearFormIntegrator_GetDefaultIntegrationRule(self, trial_fe, test_fe, trans)
    GetDefaultIntegrationRule = _swig_new_instance_method(_nonlininteg.PyNonlinearFormIntegrator_GetDefaultIntegrationRule)
