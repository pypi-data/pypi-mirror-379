...
#define SWIGTYPE_p_mfem__MemoryManager swig_types[2]
...
SWIGINTERN int Swig_var_MemoryTypeName_set(PyObject *_val) {
  {
    ...
    if (!SWIG_IsOK(res)) {
      ...
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""mfem::MemoryTypeName""' of type '""char const *[mfem::MemoryTypeSize]""'");
    }
  }
  return 0;
fail:
...
SWIGINTERN PyObject *_wrap_MemoryManager_PrintPtrs(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (obj1) {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MemoryManager_PrintPtrs" "', argument " "2"" of type '" "std::ostream &""'"); 
    }
...
SWIGINTERN PyObject *_wrap_MemoryManager_PrintAliases(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (obj1) {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MemoryManager_PrintAliases" "', argument " "2"" of type '" "std::ostream &""'"); 
    }
    arg2 = reinterpret_cast< std::ostream * >(argp2);
  }
  {
...
SWIGINTERN int Swig_var_mm_set(PyObject *_val) {
  {
    ...
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""mfem::mm""' of type '""mfem::MemoryManager""'");
    } else {
