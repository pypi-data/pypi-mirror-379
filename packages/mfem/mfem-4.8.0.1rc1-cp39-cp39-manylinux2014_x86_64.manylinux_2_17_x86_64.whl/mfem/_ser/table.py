...
class Table(object):
    ...
    def __init__(self, *args):
        ...
        __init__(Table self, Table table1, Table table2, int offset2) -> Table
        __init__(Table self, Table table1, Table table2, int offset2, Table table3, int offset3) -> Table
