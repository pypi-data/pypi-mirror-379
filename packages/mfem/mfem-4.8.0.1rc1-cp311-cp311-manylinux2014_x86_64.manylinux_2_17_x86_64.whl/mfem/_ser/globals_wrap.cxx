...
SWIGINTERN PyObject *_wrap_new_OutStream(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_OutStream" "', argument " "1"" of type '" "std::ostream &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_OutStream_SetStream(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "OutStream_SetStream" "', argument " "2"" of type '" "std::ostream &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MakeParFilename(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO|OO:MakeParFilename", kwnames, &obj0, &obj1, &obj2, &obj3)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "MakeParFilename" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN PyObject *_wrap_GetEnv(PyObject *self, PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  (void)self;
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:GetEnv", kwnames, &obj0)) SWIG_fail;
  ...
  {
    try {
      result = (char *)mfem::GetEnv((char const *)arg1);
    }
#ifdef  MFEM_USE_EXCEPTIONS
    catch (mfem::ErrorException &_e) {
      std::string s("PyMFEM error (mfem::ErrorException): "), s2(_e.what());
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "GetEnv", (PyCFunction)(void(*)(void))_wrap_GetEnv, METH_VARARGS|METH_KEYWORDS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "MFEM_VERSION",SWIG_From_int(static_cast< int >(40800)));
  SWIG_Python_SetConstant(d, "MFEM_VERSION_STRING",SWIG_FromCharPtr("4.8.0"));
  SWIG_Python_SetConstant(d, "MFEM_VERSION_TYPE",SWIG_From_int(static_cast< int >(((40800)%2))));
  ...
  SWIG_Python_SetConstant(d, "MFEM_VERSION_MAJOR",SWIG_From_int(static_cast< int >(((40800)/10000))));
  SWIG_Python_SetConstant(d, "MFEM_VERSION_MINOR",SWIG_From_int(static_cast< int >((((40800)/100)%100))));
  SWIG_Python_SetConstant(d, "MFEM_VERSION_PATCH",SWIG_From_int(static_cast< int >(((40800)%100))));
  SWIG_Python_SetConstant(d, "MFEM_SKIP_RETURN_VALUE",SWIG_From_int(static_cast< int >(242)));
