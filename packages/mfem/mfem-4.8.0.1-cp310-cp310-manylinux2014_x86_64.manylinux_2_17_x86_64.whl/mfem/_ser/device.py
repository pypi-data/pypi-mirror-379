...
class Device(object):
    ...
    @staticmethod
    def QueryMemoryType(ptr):
        return _device.Device_QueryMemoryType(ptr)
    QueryMemoryType = _swig_new_static_method(_device.Device_QueryMemoryType)

    @staticmethod
    def NumMultiprocessors(*args):
        return _device.Device_NumMultiprocessors(*args)
    NumMultiprocessors = _swig_new_static_method(_device.Device_NumMultiprocessors)

    @staticmethod
    def WarpSize(*args):
        return _device.Device_WarpSize(*args)
    WarpSize = _swig_new_static_method(_device.Device_WarpSize)

    @staticmethod
    def DeviceMem(free, total):
        return _device.Device_DeviceMem(free, total)
    DeviceMem = _swig_new_static_method(_device.Device_DeviceMem)
