...
#define SWIGTYPE_p_mfem__SumOperator swig_types[30]
...
#define SWIGTYPE_p_p_mfem__PyIntegrationRule swig_types[46]
...
#define SWIGTYPE_p_p_mfem__SumOperator swig_types[54]
...
SWIGINTERN PyObject *_wrap_Point_GetVertices__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Point_GetVertices" "', argument " "2"" of type '" "mfem::Array< int > &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_Point_SetVertices__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  mfem::Point *arg1 = (mfem::Point *) 0 ;
  mfem::Array< int > *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_mfem__Point, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Point_SetVertices" "', argument " "1"" of type '" "mfem::Point *""'"); 
  }
  arg1 = reinterpret_cast< mfem::Point * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_mfem__ArrayT_int_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Point_SetVertices" "', argument " "2"" of type '" "mfem::Array< int > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Point_SetVertices" "', argument " "2"" of type '" "mfem::Array< int > const &""'"); 
  }
  arg2 = reinterpret_cast< mfem::Array< int > * >(argp2);
  {
    try {
      (arg1)->SetVertices((mfem::Array< int > const &)*arg2);
    }
#ifdef  MFEM_USE_EXCEPTIONS
    catch (mfem::ErrorException &_e) {
      std::string s("PyMFEM error (mfem::ErrorException): "), s2(_e.what());
...
SWIGINTERN PyObject *_wrap_Point_SetVertices__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  mfem::Point *arg1 = (mfem::Point *) 0 ;
  int *arg2 = (int *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (PyInt_Check(swig_obj[1])) {
      temp2 = PyInt_AsLong(swig_obj[1]);
    } else if ((PyArray_PyIntAsInt(swig_obj[1]) != -1) || !PyErr_Occurred()) {
      temp2 = PyArray_PyIntAsInt(swig_obj[1]);
    } else {
      PyErr_SetString(PyExc_ValueError, "Expecting a integer");
      return NULL;
    }
...
SWIGINTERN PyObject *_wrap_Point_SetVertices(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "Point_SetVertices", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    void *vptr = 0;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_Point_SetVertices__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_Point_SetVertices__SWIG_1(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'Point_SetVertices'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    mfem::Point::SetVertices(mfem::Array< int > const &)\n"
    "    mfem::Point::SetVertices(int const *)\n");
  return 0;
}
...
SWIGINTERN PyObject *_wrap_Point_GetNFaces__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Point_GetNFaces" "', argument " "2"" of type '" "int &""'"); 
  }
...
SWIGINTERN int Swig_var_PointFE_set(PyObject *_val) {
  {
    ...
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""mfem::PointFE""' of type '""mfem::PointFiniteElement""'");
    } else {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Point_GetVertices", _wrap_Point_GetVertices, METH_VARARGS, "\n"
		...
		""},
	 { "Point_SetVertices", _wrap_Point_SetVertices, METH_VARARGS, "\n"
		"Point_SetVertices(Point self, intArray v)\n"
		"Point_SetVertices(Point self, int const * ind)\n"
		""},
