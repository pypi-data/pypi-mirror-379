...
class InverseElementTransformation(object):
    ...
    EdgeScan = _eltrans.InverseElementTransformation_EdgeScan
    ...
    def SetInitGuessOrder(self, order):
        r"""SetInitGuessOrder(InverseElementTransformation self, int order)"""
        return _eltrans.InverseElementTransformation_SetInitGuessOrder(self, order)
    SetInitGuessOrder = _swig_new_instance_method(_eltrans.InverseElementTransformation_SetInitGuessOrder)
...
class BatchInverseElementTransformation(object):
    r"""Proxy of C++ mfem::BatchInverseElementTransformation class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(BatchInverseElementTransformation self) -> BatchInverseElementTransformation
        __init__(BatchInverseElementTransformation self, mfem::GridFunction const & nodes, mfem::MemoryType d_mt=DEFAULT) -> BatchInverseElementTransformation
        __init__(BatchInverseElementTransformation self, mfem::Mesh const & mesh, mfem::MemoryType d_mt=DEFAULT) -> BatchInverseElementTransformation
        """
        _eltrans.BatchInverseElementTransformation_swiginit(self, _eltrans.new_BatchInverseElementTransformation(*args))
    __swig_destroy__ = _eltrans.delete_BatchInverseElementTransformation

    def SetInitialGuessType(self, itype):
        r"""SetInitialGuessType(BatchInverseElementTransformation self, mfem::InverseElementTransformation::InitGuessType itype)"""
        return _eltrans.BatchInverseElementTransformation_SetInitialGuessType(self, itype)
    SetInitialGuessType = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetInitialGuessType)

    def SetInitGuessPointsType(self, q_type):
        r"""SetInitGuessPointsType(BatchInverseElementTransformation self, int q_type)"""
        return _eltrans.BatchInverseElementTransformation_SetInitGuessPointsType(self, q_type)
    SetInitGuessPointsType = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetInitGuessPointsType)

    def SetInitGuessRelOrder(self, order):
        r"""SetInitGuessRelOrder(BatchInverseElementTransformation self, int order)"""
        return _eltrans.BatchInverseElementTransformation_SetInitGuessRelOrder(self, order)
    SetInitGuessRelOrder = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetInitGuessRelOrder)

    def SetInitGuessOrder(self, order):
        r"""SetInitGuessOrder(BatchInverseElementTransformation self, int order)"""
        return _eltrans.BatchInverseElementTransformation_SetInitGuessOrder(self, order)
    SetInitGuessOrder = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetInitGuessOrder)

    def GetBasisType(self):
        r"""GetBasisType(BatchInverseElementTransformation self) -> int"""
        return _eltrans.BatchInverseElementTransformation_GetBasisType(self)
    GetBasisType = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_GetBasisType)

    def SetSolverType(self, stype):
        r"""SetSolverType(BatchInverseElementTransformation self, mfem::InverseElementTransformation::SolverType stype)"""
        return _eltrans.BatchInverseElementTransformation_SetSolverType(self, stype)
    SetSolverType = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetSolverType)

    def SetMaxIter(self, max_it):
        r"""SetMaxIter(BatchInverseElementTransformation self, int max_it)"""
        return _eltrans.BatchInverseElementTransformation_SetMaxIter(self, max_it)
    SetMaxIter = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetMaxIter)

    def SetReferenceTol(self, ref_sp_tol):
        r"""SetReferenceTol(BatchInverseElementTransformation self, mfem::real_t ref_sp_tol)"""
        return _eltrans.BatchInverseElementTransformation_SetReferenceTol(self, ref_sp_tol)
    SetReferenceTol = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetReferenceTol)

    def SetPhysicalRelTol(self, phys_rel_tol):
        r"""SetPhysicalRelTol(BatchInverseElementTransformation self, mfem::real_t phys_rel_tol)"""
        return _eltrans.BatchInverseElementTransformation_SetPhysicalRelTol(self, phys_rel_tol)
    SetPhysicalRelTol = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_SetPhysicalRelTol)

    def UpdateNodes(self, *args):
        r"""
        UpdateNodes(BatchInverseElementTransformation self, mfem::GridFunction const & nodes, mfem::MemoryType d_mt=DEFAULT)
        UpdateNodes(BatchInverseElementTransformation self, mfem::Mesh const & mesh, mfem::MemoryType d_mt=DEFAULT)
        """
        return _eltrans.BatchInverseElementTransformation_UpdateNodes(self, *args)
    UpdateNodes = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_UpdateNodes)

    def Transform(self, pts, elems, types, refs, use_device=True, iters=None):
        r"""Transform(BatchInverseElementTransformation self, Vector pts, intArray elems, intArray types, Vector refs, bool use_device=True, intArray iters=None)"""
        return _eltrans.BatchInverseElementTransformation_Transform(self, pts, elems, types, refs, use_device, iters)
    Transform = _swig_new_instance_method(_eltrans.BatchInverseElementTransformation_Transform)

# Register BatchInverseElementTransformation in _eltrans:
_eltrans.BatchInverseElementTransformation_swigregister(BatchInverseElementTransformation)
