...
class SparseMatrix(mfem._ser.matrix.AbstractSparseMatrix):
    ...
    def GetBlocks(self, blocks):
        r"""GetBlocks(SparseMatrix self, SparseMatrixArray2D blocks)"""
    ...
    def PrintMathematica(self, *args, **kwargs):
        r"""PrintMathematica(SparseMatrix self, std::ostream & out=out)"""
        return _sparsemat.SparseMatrix_PrintMathematica(self, *args, **kwargs)
    PrintMathematica = _swig_new_instance_method(_sparsemat.SparseMatrix_PrintMathematica)
