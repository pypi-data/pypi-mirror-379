...
class Element(object):
    ...
    @staticmethod
    def TypeFromGeometry(geom):
        r"""TypeFromGeometry(mfem::Geometry::Type const geom) -> mfem::Element::Type"""
        return _element.Element_TypeFromGeometry(geom)
    TypeFromGeometry = _swig_new_static_method(_element.Element_TypeFromGeometry)
