...
#define SWIGTYPE_p_mfem__PyIntegrationRule swig_types[21]
...
#define SWIGTYPE_p_mfem__Segment swig_types[28]
...
SWIGINTERN PyObject *_wrap_Segment_GetVertices__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Segment_GetVertices" "', argument " "2"" of type '" "mfem::Array< int > &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_Segment_SetVertices__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  mfem::Segment *arg1 = (mfem::Segment *) 0 ;
  mfem::Array< int > *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Segment_SetVertices" "', argument " "2"" of type '" "mfem::Array< int > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Segment_SetVertices" "', argument " "2"" of type '" "mfem::Array< int > const &""'"); 
  }
  arg2 = reinterpret_cast< mfem::Array< int > * >(argp2);
  {
    try {
...
SWIGINTERN PyObject *_wrap_Segment_SetVertices__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  mfem::Segment *arg1 = (mfem::Segment *) 0 ;
  int *arg2 = (int *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_Segment_SetVertices(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "Segment_SetVertices", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    void *vptr = 0;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_Segment_SetVertices__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      {
        ...
        if (PyList_Check(argv[1])){
          if  (PyList_Size(argv[1]) == 2){
            _v = 1;
          }
        }
        if (PyTuple_Check(argv[1])){
          if  (PyTuple_Size(argv[1]) == 2){
            _v = 1;
          }
        }
      ...
      if (_v) {
        return _wrap_Segment_SetVertices__SWIG_1(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'Segment_SetVertices'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    mfem::Segment::SetVertices(mfem::Array< int > const &)\n"
    "    mfem::Segment::SetVertices(int const *)\n");
  return 0;
}
...
SWIGINTERN PyObject *_wrap_Segment_GetNFaces__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "Segment_GetNFaces" "', argument " "2"" of type '" "int &""'"); 
  }
...
SWIGINTERN int Swig_var_SegmentFE_set(PyObject *_val) {
  {
    ...
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""mfem::SegmentFE""' of type '""mfem::Linear1DFiniteElement""'");
    } else {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Segment_GetVertices", _wrap_Segment_GetVertices, METH_VARARGS, "\n"
		...
		""},
	 { "Segment_SetVertices", _wrap_Segment_SetVertices, METH_VARARGS, "\n"
		"Segment_SetVertices(Segment self, intArray v)\n"
		"Segment_SetVertices(Segment self, int const * ind)\n"
		""},
