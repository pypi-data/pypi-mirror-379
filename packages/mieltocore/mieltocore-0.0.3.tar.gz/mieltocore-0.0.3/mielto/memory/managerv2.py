...
class MemoryManager:
    ...
    # -*- Public Functions
    def get_user_memories(self, user_id: Optional[str]) -> Optional[List[UserMemory]]:
    ...
    def get_system_message(
        ...
        system_prompt_lines.append("Note: Ensure you reply in whatever language the user's message is in. Detect the language and reply in the same language.")
