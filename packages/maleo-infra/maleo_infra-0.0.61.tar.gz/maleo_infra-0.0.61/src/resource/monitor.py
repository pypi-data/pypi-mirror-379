...
from maleo.schemas.security.authentication import AnyAuthenticationT
from maleo.schemas.security.authorization import OptionalAuthorization
...
class ResourceMonitor:
    ...
    async def _measure(
        ...
        if log:
            SuccessfulSystemOperation[
                ...
                timestamp=timestamp,
                summary=(
                    f"Successfully measured resource usage"
                    f" - Overall ({status})"
    ...
    def get_measurement_history(
        ...
        *,
        ...
        authentication: Optional[AnyAuthenticationT] = None,
    ...
    def get_average_usage(
        ...
        *,
        ...
        authorization: OptionalAuthorization = None,
        impersonation: OptionalImpersonation = None,
    ) -> OptionalSingleDataResponse[Measurement[AggregateUsage], None]:
        """
        ...
        if not history_data:
            return OptionalSingleDataResponse[Measurement[AggregateUsage], None](
        ...
        response = OptionalSingleDataResponse[Measurement[AggregateUsage], None](
            data=data, metadata=None, other=None
        )
        ...
        SuccessfulSystemOperation[
            ...
            timestamp=timestamp,
            summary=(
                f"Successfully measured average resource usage of the last {window} seconds"
                f" - Overall ({status})"
                f" - CPU ({avg_cpu.status}) | Raw: {avg_cpu.raw:.2f}% | Smooth: {avg_cpu.smooth:.2f}%"
                f" - Memory ({avg_memory.status}) | Raw: {avg_memory.raw:.2f}MB | Percentage: {avg_memory.percentage:.2f}%"
            ),
            connection_context=connection_context,
            authentication=authentication,
            authorization=authorization,
    ...
    def get_peak_usage(
        ...
        *,
        ...
        SuccessfulSystemOperation[
            ...
            timestamp=timestamp,
            summary=(
                f"Successfully measured peak resource usage of the last {window} seconds"
                f" - Overall ({status})"
                f" - CPU ({peak_cpu.status}) | Raw: {peak_cpu.raw:.2f}% | Smooth: {peak_cpu.smooth:.2f}%"
                f" - Memory ({peak_memory.status}) | Raw: {peak_memory.raw:.2f}MB | Percentage: {peak_memory.percentage:.2f}%"
            ),
            connection_context=connection_context,
            authentication=authentication,
            authorization=authorization,
    ...
    async def get_instant_usage(
        ...
        *,
        ...
        SuccessfulSystemOperation[
            ...
            timestamp=timestamp,
            summary=(
                f"Successfully measured instant resource usage"
                f" - Overall ({status})"
                f" - CPU ({cpu_usage.status}) | Raw: {cpu_usage.raw:.2f}% | Smooth: {cpu_usage.smooth:.2f}%"
                f" - Memory ({memory_usage.status}) | Raw: {memory_usage.raw:.2f}MB | Percentage: {memory_usage.percentage:.2f}%"
            ),
