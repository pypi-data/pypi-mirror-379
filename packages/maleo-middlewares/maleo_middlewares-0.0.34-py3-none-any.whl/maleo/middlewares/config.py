...
class RateLimiterConfig(BaseModel):
    limit: Annotated[
        int, Field(10, description="Request limit (per 'window' seconds)")
    ] = 10
    window: Annotated[int, Field(1, description="Request limit window (seconds)")] = 1
    cleanup_interval: Annotated[
        int, Field(60, description="Interval for middleware cleanup (seconds)")
    ] = 60
    idle_timeout: Annotated[int, Field(300, description="Idle timeout (seconds)")] = 300
