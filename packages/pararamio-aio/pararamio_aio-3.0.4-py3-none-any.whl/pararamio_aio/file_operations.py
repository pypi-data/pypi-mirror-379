...
async def async_xupload_file(
    ...
    *,
    ...
    # Make request
    response = await client.post(url, content=data, headers=_headers, timeout=timeout)
...
async def async_delete_file(
    ...
    response = await client.delete(url, headers=_headers, timeout=timeout)
...
async def async_download_file(
    ...
    response = await client.get(url, headers=_headers, timeout=timeout)
    if response.status_code == 200:
