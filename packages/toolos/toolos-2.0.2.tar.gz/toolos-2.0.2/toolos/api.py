...
class GuiAPI:
    ...
    def __init__(self):
        self.tkinter = TkinterEngine()
    

class TkinterEngine(tkinter):
    def __init__(self):
        super().__init__()
        self.ROOT = None
...
class Api:
    ...
    #? ################  Super EngineFramework  #####################
    # Sandbox-Only Made for custom Engine-Development with Framework class.
class Framework:
        
    def __init__(self, **app):
        """Rquires SDK dict: {version, name, standard_language_library, settingspath}. Build for Engine-Development."""
        self.SDK = app
        self.SDK_VERSION = app.get("version")
        self.SDK_NAME = app.get("name")
        self.SDK_LangLib = app.get("standard_language_library")
        self.SDK_SETTINGS = app.get("settingspath", "settings.json")
        self.app = Api()
        self.sdk = ToolAPI(self.SDK_SETTINGS, version=self.SDK_VERSION, name=self.SDK_NAME, standard_language_library=self.SDK_LangLib)
        self.URSINADAT = ursina
        self.ursina = ursina.Ursina()
