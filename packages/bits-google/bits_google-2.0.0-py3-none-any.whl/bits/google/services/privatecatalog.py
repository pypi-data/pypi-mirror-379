...
class PrivateCatalog(Base):
    ...
    def __init__(self, credentials, api_key):
        ...
        self.privatecatalog_alpha = build(
            ...
            discoveryServiceUrl=f'https://cloudprivatecatalog.googleapis.com/$discovery/rest?version=v1alpha1&key={api_key}',
            cache_discovery=False
        )
        self.catalogproducer = build(
            'cloudprivatecatalogproducer', 'v1beta1', credentials=credentials, cache_discovery=False
        )
