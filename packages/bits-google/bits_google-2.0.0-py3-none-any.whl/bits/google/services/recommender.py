...
class Recommender(Base):
    ...
    def get_insights(self, resource, zone, recommender):
        ...
        url = f"{self.base_url}/{resource}/locations/{zone}/insightTypes/{recommender}/insights"
    ...
    def get_recommendations(self, resource, zone, recommender):
        ...
        url = f"{self.base_url}/{resource}/locations/{zone}/recommenders/{recommender}/recommendations"
        response = self.requests.get(url)
