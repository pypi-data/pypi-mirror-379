...
class StorageClient:
    ...
    def put_object(self,bucket_name: str, object_name: str, data: str,length, **kwargs):
        return self.client.put_object(bucket_name=bucket_name,object_name=object_name,data=data,length=length,**kwargs)
