        ...
        if workspace.is_same_model(model_name, model_version):
            ...
            if workspace.git_ops.has_user_changes():
                ...
                if iteration:
                    ...
                    console.print(
                        f"Run 'vcp model workflow --work-dir {work_dir}' to see what needs to be addressed."
                    )
        ...
        if workflow_help:
            ...
            console.print(
                Panel(
                    ...
                    "[bold yellow]💡 Tip:[/bold yellow] Use [cyan]vcp model workflow[/cyan] for step-by-step guidance!",
