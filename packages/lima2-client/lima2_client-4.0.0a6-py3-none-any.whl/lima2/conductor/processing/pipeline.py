...
class Pipeline:
    ...
    async def num_available(self, source: str) -> int:
        ...
        # TODO(mdu) this gives us the number of contiguous frames that *entered*
        # the processing.
        # Is there a reliable way for conductor to tell how many *processed*
        # frames are available ? Based on progress counters ? Or a combination
        # of progress counters and the lookup table ? Maybe last_frames() ?

        return self.lut.num_contiguous()
