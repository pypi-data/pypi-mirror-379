...
set_target_properties(turboxl::turboxl_core PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/turboxl_core.lib"
  )

list(APPEND _cmake_import_check_targets turboxl::turboxl_core )
list(APPEND _cmake_import_check_files_for_turboxl::turboxl_core "${_IMPORT_PREFIX}/lib/turboxl_core.lib" )
