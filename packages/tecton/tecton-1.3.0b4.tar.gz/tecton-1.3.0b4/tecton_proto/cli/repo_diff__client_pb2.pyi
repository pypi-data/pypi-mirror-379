...
class TectonObjectType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    TECTON_OBJECT_TYPE_UNKNOWN: _ClassVar[TectonObjectType]
    ENTITY: _ClassVar[TectonObjectType]
    DATA_SOURCE: _ClassVar[TectonObjectType]
    TRANSFORMATION: _ClassVar[TectonObjectType]
    FEATURE_VIEW: _ClassVar[TectonObjectType]
    FEATURE_SERVICE: _ClassVar[TectonObjectType]
    SERVER_GROUP: _ClassVar[TectonObjectType]
    RESOURCE_PROVIDER: _ClassVar[TectonObjectType]
...
class TectonObjectDiff(_message.Message):
    __slots__ = ["transition_type", "transition_side_effects", "object_metadata", "warnings"]
...
class TectonObjectMetadata(_message.Message):
    __slots__ = ["name", "object_type", "owner", "description", "tags"]
