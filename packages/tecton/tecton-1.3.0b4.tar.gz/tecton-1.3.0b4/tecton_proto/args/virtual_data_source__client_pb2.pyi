...
class VirtualDataSourceArgs(_message.Message):
    __slots__ = ["virtual_data_source_id", "info", "version", "prevent_destroy", "options", "hive_ds_config", "file_ds_config", "redshift_ds_config", "snowflake_ds_config", "spark_batch_config", "unity_ds_config", "pandas_batch_config", "bigquery_ds_config", "pyarrow_batch_config", "kinesis_ds_config", "kafka_ds_config", "spark_stream_config", "push_config", "schema", "type", "forced_batch_schema", "forced_stream_schema"]
