...
class DiffTestArgs(_message.Message):
    __slots__ = ["test_args_id", "info", "new_field", "old_field", "passive_field", "recreate_suppressable_field", "recreate_suppressable_nested_field", "recreate_suppressable_invalidate_checkpoints_field", "recreate_suppressable_invalidate_checkpoints_nested_field", "recreate_suppressable_restart_stream_field", "unannotated_needing_recreate", "options", "renamed_primitive_field", "renamed_message_field"]
