...
class TransformationMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    TRANSFORMATION_MODE_UNSPECIFIED: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_PYSPARK: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_SPARK_SQL: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_PANDAS: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_SNOWFLAKE_SQL: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_PYTHON: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_SNOWPARK: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_BIGQUERY_SQL: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_NO_TRANSFORMATION: _ClassVar[TransformationMode]
    TRANSFORMATION_MODE_PYARROW: _ClassVar[TransformationMode]
...
class TransformationArgs(_message.Message):
    __slots__ = ["transformation_id", "info", "version", "prevent_destroy", "options", "transformation_mode", "user_function", "docstring", "is_builtin"]
