...
class CanaryFeatureViewType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    UNDEFINED: _ClassVar[CanaryFeatureViewType]
    TEMPORAL_FEATURE_VIEW: _ClassVar[CanaryFeatureViewType]
    WINDOW_AGGREGATE_FEATURE_VIEW: _ClassVar[CanaryFeatureViewType]
...
class CanaryUpdate(_message.Message):
    __slots__ = ["table_name", "serialized_items", "condition_expression", "dynamo_expression_attribute_names", "dynamo_expression_attribute_values", "time", "is_status_table", "feature_view_type"]
