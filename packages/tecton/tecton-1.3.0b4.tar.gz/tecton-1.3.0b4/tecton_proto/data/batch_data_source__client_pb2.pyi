...
class FileDataSourceFormat(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    FILE_DATA_SOURCE_FORMAT_JSON: _ClassVar[FileDataSourceFormat]
    FILE_DATA_SOURCE_FORMAT_PARQUET: _ClassVar[FileDataSourceFormat]
    FILE_DATA_SOURCE_FORMAT_CSV: _ClassVar[FileDataSourceFormat]
...
class BatchDataSource(_message.Message):
    __slots__ = ["hive_table", "file", "redshift_db", "snowflake", "spark_data_source_function", "unity_table", "push_source_table", "pandas_data_source_function", "bigquery", "pyarrow_data_source_function", "spark_schema", "timestamp_column_properties", "batch_config", "date_partition_column", "datetime_partition_columns", "raw_batch_translator", "data_delay", "secrets"]
...
class UnityTableDataSource(_message.Message):
    __slots__ = ["catalog", "schema", "table", "access_mode"]
...
class FileDataSource(_message.Message):
    __slots__ = ["uri", "format", "convert_to_glue_format", "schema_uri", "schema_override"]
...
class RedshiftDataSource(_message.Message):
    __slots__ = ["endpoint", "cluster_id", "database", "table", "query", "temp_s3"]
...
class BigqueryDataSource(_message.Message):
    __slots__ = ["project_id", "dataset", "location", "table", "query", "credentials"]
