...
class TectonApiKey(_message.Message):
    __slots__ = ["id", "string_id", "hashed_key", "description", "archived", "created_by", "obscured_key", "is_admin", "name", "is_active", "creator", "created_at", "is_system_managed", "is_temporary", "expires_at", "credentials_type"]
