...
class RayMaterializationWorkflow(_message.Message):
    __slots__ = ["task", "workspace_state_id", "anyscale_job_id", "final_run_details", "consumption_scrape_watermark", "state_transitions", "instance_launch_time", "approx_instance_termination_time", "import_table_info"]
