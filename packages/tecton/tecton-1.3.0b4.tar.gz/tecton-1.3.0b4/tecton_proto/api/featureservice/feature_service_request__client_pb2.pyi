...
class MetadataOptions(_message.Message):
    __slots__ = ["include_names", "include_effective_times", "include_types", "include_data_types", "include_slo_info", "include_serving_status", "include_feature_descriptions", "include_feature_tags"]
...
class RequestOptions(_message.Message):
    __slots__ = ["read_from_cache", "write_to_cache", "ignore_extra_request_context_fields", "latency_budget_ms", "coerce_null_counts_to_zero", "enable_lastn_optimization", "aggregation_leading_edge", "high_watermark_override"]
...
class GetFeaturesParameters(_message.Message):
    __slots__ = ["feature_service_id", "feature_service_name", "feature_package_id", "feature_package_name", "feature_view_id", "feature_view_name", "workspace_name", "join_key_map", "request_context_map", "metadata_options", "allow_partial_results", "request_options", "isCallerBatch"]
...
class GetFeaturesParametersV2(_message.Message):
    __slots__ = ["feature_service_name", "workspace_name", "join_key_map", "request_context_map", "metadata_options", "allow_partial_results", "request_options", "isCallerBatch"]
    class JoinKeyMapEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class GetFeaturesBatchParameters(_message.Message):
    __slots__ = ["feature_service_id", "feature_service_name", "workspace_name", "request_data", "metadata_options", "request_options"]
    FEATURE_SERVICE_ID_FIELD_NUMBER: _ClassVar[int]
    FEATURE_SERVICE_NAME_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_NAME_FIELD_NUMBER: _ClassVar[int]
...
class GetFeaturesBatchParametersV2(_message.Message):
    __slots__ = ["feature_service_name", "workspace_name", "request_data", "metadata_options", "request_options"]
    FEATURE_SERVICE_NAME_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_NAME_FIELD_NUMBER: _ClassVar[int]
    REQUEST_DATA_FIELD_NUMBER: _ClassVar[int]
    METADATA_OPTIONS_FIELD_NUMBER: _ClassVar[int]
