...
class FeatureValue(_message.Message):
    __slots__ = ["array_value", "float64_value", "float32_value", "int64_value", "bool_value", "string_value", "null_value", "struct_value", "map_value"]
...
class RedisTAFVData(_message.Message):
    __slots__ = ["anchor_time", "written_by_batch", "feature_values"]
...
class ArrayValue(_message.Message):
    __slots__ = ["string_values", "array_values", "struct_values", "map_values", "bool_values", "int64_values", "float32_values", "float64_values", "null_indices"]
...
class CachedFeatureView(_message.Message):
    __slots__ = ["feature_values", "feature_statuses", "effective_time", "updated_at"]
    FEATURE_VALUES_FIELD_NUMBER: _ClassVar[int]
