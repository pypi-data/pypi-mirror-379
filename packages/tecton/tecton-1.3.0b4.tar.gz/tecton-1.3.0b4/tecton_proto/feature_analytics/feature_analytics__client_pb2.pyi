...
class FeatureViewSimilarityType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    FEATURE_VIEW_SIMILARITY_UNKNOWN: _ClassVar[FeatureViewSimilarityType]
    FEATURE_VIEW_SIMILARITY_DUPLICATE: _ClassVar[FeatureViewSimilarityType]
    FEATURE_VIEW_SIMILARITY_NEAR_DUPLICATE: _ClassVar[FeatureViewSimilarityType]
...
class FeatureViewSimilarityPair(_message.Message):
    __slots__ = ["fv_locator_second", "workspace_state_id_second", "similarity", "type", "fv_details_second", "similarity_description"]
...
class FeatureViewSimilarityGroup(_message.Message):
    __slots__ = ["fv_locator_first", "workspace_state_id_first", "fv_details_first", "pairs"]
