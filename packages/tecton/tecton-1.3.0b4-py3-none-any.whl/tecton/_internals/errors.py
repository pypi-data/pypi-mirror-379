...
REALTIME_ENVIRONMENT_DEPRECATED = (
    "The 'realtime_environment' parameter is deprecated and will be removed in the next SDK release. "
    "Please use 'transform_server_group' instead to define the job runtime environment."
)
