...
class VmMaterializationWorkflow(_message.Message):
    __slots__ = ["task", "workspace_state_id", "vm_instance_id", "vm_instance_region", "vm_instance_zone", "final_run_details", "consumption_scrape_watermark", "state_transitions", "instance_launch_time", "approx_instance_termination_time", "import_table_info"]
...
class VmMaterializationStateTransition(_message.Message):
    __slots__ = ["state", "timestamp", "state_message"]
