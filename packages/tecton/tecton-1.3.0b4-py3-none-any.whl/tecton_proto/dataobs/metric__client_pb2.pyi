...
class MetricType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    METRIC_TYPE_UNKNOWN: _ClassVar[MetricType]
    COUNT_DISTINCT: _ClassVar[MetricType]
    COUNT_ROWS: _ClassVar[MetricType]
    COUNT_NULLS: _ClassVar[MetricType]
    COUNT_ZEROS: _ClassVar[MetricType]
    AVG_VALUE: _ClassVar[MetricType]
    MAX_VALUE: _ClassVar[MetricType]
    MIN_VALUE: _ClassVar[MetricType]
    VAR_SAMPLE: _ClassVar[MetricType]
    STDDEV_SAMPLE: _ClassVar[MetricType]
    AVG_LENGTH: _ClassVar[MetricType]

class MetricStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    METRIC_STATUS_UNKNOWN: _ClassVar[MetricStatus]
    METRIC_STATUS_AVAILABLE: _ClassVar[MetricStatus]
    METRIC_STATUS_UNAVAILABLE: _ClassVar[MetricStatus]
    METRIC_STATUS_NO_MATERIALIZATION: _ClassVar[MetricStatus]
...
class Metric(_message.Message):
    __slots__ = ["name", "expression", "window", "interval", "input_column_names", "creation_time", "last_update_time"]
...
class MetricDataPoint(_message.Message):
    __slots__ = ["interval_start_time", "metric_values", "materialization_run_id", "materialization_task_attempt_url", "metric_status"]
...
class FeatureMetric(_message.Message):
    __slots__ = ["metric_type", "feature_name", "column_name"]
