...
class DataTypeEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    DATA_TYPE_UNKNOWN: _ClassVar[DataTypeEnum]
    DATA_TYPE_INT32: _ClassVar[DataTypeEnum]
    DATA_TYPE_INT64: _ClassVar[DataTypeEnum]
    DATA_TYPE_FLOAT32: _ClassVar[DataTypeEnum]
    DATA_TYPE_FLOAT64: _ClassVar[DataTypeEnum]
    DATA_TYPE_STRING: _ClassVar[DataTypeEnum]
    DATA_TYPE_BOOL: _ClassVar[DataTypeEnum]
    DATA_TYPE_TIMESTAMP: _ClassVar[DataTypeEnum]
    DATA_TYPE_ARRAY: _ClassVar[DataTypeEnum]
    DATA_TYPE_STRUCT: _ClassVar[DataTypeEnum]
    DATA_TYPE_TIMESTAMP_INT96: _ClassVar[DataTypeEnum]
    DATA_TYPE_MAP: _ClassVar[DataTypeEnum]
...
class DataType(_message.Message):
    __slots__ = ["type", "array_element_type", "struct_fields", "map_key_type", "map_value_type"]
