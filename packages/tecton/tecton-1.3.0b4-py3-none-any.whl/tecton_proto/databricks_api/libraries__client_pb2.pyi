...
class LibraryStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    RESOLVING: _ClassVar[LibraryStatus]
    INSTALLING: _ClassVar[LibraryStatus]
    INSTALLED: _ClassVar[LibraryStatus]
    FAILED: _ClassVar[LibraryStatus]
    UNINSTALL_ON_RESTART: _ClassVar[LibraryStatus]
    SKIPPED: _ClassVar[LibraryStatus]
    RESTORED: _ClassVar[LibraryStatus]
