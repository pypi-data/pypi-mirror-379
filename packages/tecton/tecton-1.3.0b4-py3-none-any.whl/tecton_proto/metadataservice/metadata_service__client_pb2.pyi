...
class RequestConfigurationCheckRecalculationRequest(_message.Message):
    __slots__ = []
    def __init__(self) -> None: ...

class RequestConfigurationCheckRecalculationResponse(_message.Message):
    __slots__ = ["status"]
    class RecalculationStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        STATUS_UNKNOWN: _ClassVar[RequestConfigurationCheckRecalculationResponse.RecalculationStatus]
        STATUS_NEWLY_REQUESTED: _ClassVar[RequestConfigurationCheckRecalculationResponse.RecalculationStatus]
        STATUS_ALREADY_REQUESTED: _ClassVar[RequestConfigurationCheckRecalculationResponse.RecalculationStatus]
    STATUS_UNKNOWN: RequestConfigurationCheckRecalculationResponse.RecalculationStatus
    STATUS_NEWLY_REQUESTED: RequestConfigurationCheckRecalculationResponse.RecalculationStatus
    STATUS_ALREADY_REQUESTED: RequestConfigurationCheckRecalculationResponse.RecalculationStatus
    STATUS_FIELD_NUMBER: _ClassVar[int]
    status: RequestConfigurationCheckRecalculationResponse.RecalculationStatus
    def __init__(self, status: _Optional[_Union[RequestConfigurationCheckRecalculationResponse.RecalculationStatus, str]] = ...) -> None: ...
