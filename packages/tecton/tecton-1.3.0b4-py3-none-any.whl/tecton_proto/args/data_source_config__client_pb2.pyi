...
class InitialStreamPosition(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    INITIAL_STREAM_POSITION_UNSPECIFIED: _ClassVar[InitialStreamPosition]
    INITIAL_STREAM_POSITION_LATEST: _ClassVar[InitialStreamPosition]
    INITIAL_STREAM_POSITION_TRIM_HORIZON: _ClassVar[InitialStreamPosition]
