...
class DataSourceSpecArgsSupplement:
    ...
    data_source_auth_function: Optional[Callable] = attrs.field(default=None)
...
class SnowflakeSourceSpec(BatchSourceSpec):
    ...
    connection_provider: Optional[Callable]
    ...
    def from_data_proto(
        ...
        if proto.snowflake.snowflakeArgs.HasField("connection_provider"):
            connection_provider = function_deserialization.from_proto(
                proto.snowflake.snowflakeArgs.connection_provider, include_main_variables_in_scope
            )
    ...
    def from_args_proto(
        ...
        if proto.HasField("connection_provider"):
            connection_provider = function_deserialization.from_proto(proto.connection_provider)
        else:
            connection_provider = supplement.data_source_auth_function
