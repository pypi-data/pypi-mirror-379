...
class Browser(DynamicCore):
    ...
    def merge_coverage_reports(self, input_folder: Path, output_folder: Path, config_file: typing.Optional[pathlib.Path] = None, name: typing.Optional[str] = None, reports: typing.Optional[list[str]] = None): ...
