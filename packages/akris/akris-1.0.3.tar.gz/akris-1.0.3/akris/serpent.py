...
__testkey = bytes.fromhex(
    "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"
)
# __testkey = bytes('\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f')
__testdat = bytes.fromhex("000102030405060708090a0b0c0d0e0f")
# __testdat = bytes('\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x0f')
assert bytes.fromhex("de269ff833e432b85b2e88d2701ce75c") == Serpent(__testkey).encrypt(
    __testdat
)
# assert '\xde&\x9f\xf83\xe42\xb8[.\x88\xd2p\x1c\xe7\\' == Serpent(__testkey).encrypt(__testdat)
# assert __testdat == Serpent(__testkey).decrypt(bytes.fromhex('\xde&\x9f\xf83\xe42\xb8[.\x88\xd2p\x1c\xe7\\'))
