...
class DSPyLLMClient(LLMClient):
    ...
    def _setup_lm(self) -> None:
        ...
        if self.config.provider == "openai":
            ...
            if not api_key:
                raise ValueError(
                    "OpenAI API key required. Run 'dococtopy config setup' to configure, "
            ...
            if not api_key:
                raise ValueError(
                    "Anthropic API key required. Run 'dococtopy config setup' to configure, "
            ...
            litellm.api_base = (  # noqa: F841, B110
                self.config.base_url or "http://localhost:11434"
            )  # vulture: ignore[unused_attribute]
    ...
    def generate_docstring(
        ...
        try:
            ...
            # Debug: Check what type of object we get back
            if hasattr(result, "docstring"):
                return result.docstring
            else:
                # If result is a string directly, return it
                if isinstance(result, str):
                    return result
                # If result is a dict-like object, try to get the docstring
                if hasattr(result, "get"):
                    return result.get("docstring", str(result))
    ...
    def fix_docstring(
        ...
        try:
            ...
            # Check what type of object we get back
            if hasattr(result, "fixed_docstring"):
                ...
                # If result is a dict-like object, try to get the docstring
                if hasattr(result, "get"):
                    return result.get("fixed_docstring", str(result))
                # Fallback to string representation
                return str(result)
        except Exception as e:
    ...
    def enhance_docstring(
        ...
        try:
            ...
            # Debug: Check what type of object we get back
            if hasattr(result, "enhanced_docstring"):
                ...
                # If result is a dict-like object, try to get the docstring
                if hasattr(result, "get"):
                    return result.get("enhanced_docstring", str(result))
                # Fallback to string representation
                return str(result)
        except Exception as e:
