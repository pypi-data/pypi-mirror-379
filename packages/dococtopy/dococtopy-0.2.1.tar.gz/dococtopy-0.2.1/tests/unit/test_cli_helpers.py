...
class TestCreateLlmConfig:
    ...
    def test_create_llm_config_basic(self, clean_env):
    ...
    def test_create_llm_config_with_openai_api_key(self, clean_env):
    ...
    def test_create_llm_config_with_anthropic_api_key(self, clean_env):
    ...
    def test_create_llm_config_with_existing_api_key(self, clean_env):
    ...
    def test_create_llm_config_with_ollama_provider(self, clean_env):
