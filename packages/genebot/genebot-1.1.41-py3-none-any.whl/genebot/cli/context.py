...
class CLIContext:
    ...
    def get_config(self) -> Dict[str, Any]:
        """Get configuration data (placeholder for testing)"""
        # This is a placeholder method for testing compatibility
        return {}
    
    def save_config(self, config_data: Dict[str, Any]) -> None:
        """Save configuration data (placeholder for testing)"""
        # This is a placeholder method for testing compatibility
        pass
    
    def load_config(self) -> Dict[str, Any]:
        """Load configuration data (placeholder for testing)"""
        # This is a placeholder method for testing compatibility
        return {}