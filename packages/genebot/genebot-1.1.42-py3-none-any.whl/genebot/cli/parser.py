...
def _add_config_commands(subparsers) -> None:
    ...
    init_parser = subparsers.add_parser(
        'init-config',
        help='Initialize configuration files and database',
        description='Create default configuration files, directory structure, and initialize database'
    )
    ...
    init_parser.add_argument(
        '--skip-database',
        action='store_true',
        help='Skip database initialization (only create configuration files)'
    )
...
def _add_utility_commands(subparsers) -> None:
    ...
    # Database testing
    db_test_parser = subparsers.add_parser(
        'db-test',
        aliases=['database-test'],
        help='Run comprehensive database tests',
        description='Run comprehensive database connectivity, CRUD, and performance tests'
    )
    db_test_parser.add_argument(
        '--database-url',
        type=str,
