...
class AIQTrainerApp:
    ...
    def __init__(self, config: dict):
        ...
        self.logger.debug("logging config: %s",format(log_config))
    ...
    def validate_data(self, dataframe: DataFrame) -> DataFrame:
        self.logger.debug("validating data - final dataframe")
    ...
    def run(self):
        ...
        if fs_config.get('active', False):
            self.logger.debug("Explicit Feature selection is ACTIVE.")
            ...
            self.logger.debug("Explicit Feature selection is INACTIVE. Using all features.")
