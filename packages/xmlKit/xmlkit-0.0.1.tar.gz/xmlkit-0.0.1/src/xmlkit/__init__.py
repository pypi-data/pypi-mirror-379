...
if TYPE_CHECKING:
    ...
    SupportsRead = Any  # Will be specialized when used
    SupportsWrite = Any  # Will be specialized when used
...
# Type alias for XML input
type XmlInput = str | ReadableBuffer | Any | Generator[ReadableBuffer]
