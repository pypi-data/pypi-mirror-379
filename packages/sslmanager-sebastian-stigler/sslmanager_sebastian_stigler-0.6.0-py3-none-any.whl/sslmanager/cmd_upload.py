...
from sslmanager.helper import choose_server_alias_and_date, DEFAULT_STYLE, DomainNameValidator
...
class CmdUpload(Plugin):
    ...
    def choose_username_and_server(self):
        ...
        completer = {key: None for key in
                     sorted(set([ssl_request_config.common_name] + ssl_request_config.subject_alt_name))}
        questions = [
            {
                "type": "input",
                "name": "ssh_username",
            ...
            },
            {
                ...
                "validate": DomainNameValidator(config=self.config),
            },
            {
                "type": "confirm",
                "name": "confirm",
