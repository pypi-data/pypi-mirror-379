...
@LastEditTime: 2025-09-11 11:35:13
...
class LoginHandler(ClientBaseHandler):
    ...
    def business_process_executed(self, result_data, ref_params):
        ...
        asyncio.create_task(self.add_stat_count(ref_params, user_info_dict))
        return result_data

    async def add_stat_count(self, ref_params, user_info_dict):
        """
        :description: 添加登录次数
        :param ref_params: 关联参数
        :param user_info_dict: 用户信息
        :return:
        :last_editors: HuangJianYi
        """
