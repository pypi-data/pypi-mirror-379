...
def _ensure_standard_paths(info: dict, registry_dir: str) -> dict:
    """
    ...
    dirbase = os.path.join(registry_dir, vid)
...
class infoRegistry:
    ...
    def get_video_info(self, url: str | None = None, video_id: str | None = None,
        ...
        if video_path and os.path.isfile(video_path):
            ...
            info["video_id"] = vid
            return _ensure_standard_paths(info, self.infoRegistryDirectory)
        ...
        if vid and not force_refresh:
            ...
            if cached:
                ...
                cached["video_id"] = vid
                return _ensure_standard_paths(cached, self.infoRegistryDirectory)
    ...
    def edit_info(self, data: dict, url: str | None = None, video_id: str | None = None, video_path: str | None = None):
        ...
        cur = _ensure_standard_paths(cur, self.infoRegistryDirectory)
