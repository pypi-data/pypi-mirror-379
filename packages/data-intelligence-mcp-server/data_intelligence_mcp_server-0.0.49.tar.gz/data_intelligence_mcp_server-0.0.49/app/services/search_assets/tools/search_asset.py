...
@service_registry.tool(
        ...
        description="""Understand user's request about searching data assets and return list of retrieved assets.
                       ...
                       Args:
                            SearchAssetRequest: The request model containing the search prompt and optional container type.
                       ...
                       """)
@auto_context
async def search_asset(request: SearchAssetRequest) -> List[SearchAssetResponse]:
    auth_scope = "catalog"
