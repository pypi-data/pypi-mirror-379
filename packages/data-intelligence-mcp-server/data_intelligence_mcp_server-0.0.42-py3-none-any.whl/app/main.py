...
from app.services.search_assets.models.search_asset import SearchAssetRequest, SearchAssetResponse
...
def create_server() -> FastMCP:
    ...
    @mcp.tool(name="system_get_prompts")
    ...
    @mcp.tool(name="search_asset",
              description="""search an asset in given catalog""")
    async def search_asset(request: SearchAssetRequest) -> str:
        auth_scope = "catalog"
        return "Hello World"
