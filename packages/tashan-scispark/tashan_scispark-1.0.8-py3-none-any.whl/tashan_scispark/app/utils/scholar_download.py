...
import urllib.parse
# from scihub_cn.scihub import SciHub  # 临时注释掉，存在构建问题
from ..core.config import OUTPUT_PATH, Proxies
...
def download_pdf_from_scihub(doi, output_path):
    # sh = SciHub(proxy=Proxies)  # 临时注释掉，存在构建问题
