...
class ConfigManager:
    ...
    def load(self) -> dict[str, Any]:
        ...
        # Control Tower SSO configuration
        ct_vars = [
            "CT_SSO_USER_EMAIL",
            "CT_SSO_USER_FIRST",
            "CT_SSO_USER_LAST",
    ...
    def get_default_sso_email(self) -> Optional[str]:
        ...
        # Prefer CT_SSO_USER_EMAIL over DEFAULT_SSO_EMAIL
        return self.get("CT_SSO_USER_EMAIL") or self.get("DEFAULT_SSO_EMAIL")
    ...
    def get_ct_sso_user(self) -> dict[str, Optional[str]]:
        """Get Control Tower SSO user configuration.

        Returns:
            Dictionary with email, first_name, last_name
        """
        return {
            "email": self.get("CT_SSO_USER_EMAIL") or self.get("DEFAULT_SSO_EMAIL"),
            "first_name": self.get("CT_SSO_USER_FIRST", "Admin"),
            "last_name": self.get("CT_SSO_USER_LAST", "User"),
        }
