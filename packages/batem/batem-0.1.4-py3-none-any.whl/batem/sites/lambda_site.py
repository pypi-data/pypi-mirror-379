...
class MyConfiguration(batem.core.lambdahouse.LambdaParametricData):
    ...
    def __init__(self, historical_site_weather_data: SiteWeatherData, prospective_site_weather_data: SiteWeatherData) -> None:
        super().__init__(historical_site_weather_data, prospective_site_weather_data)
