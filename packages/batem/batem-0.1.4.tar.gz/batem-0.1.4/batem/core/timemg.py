...
The module provides:
- TimeSeriesMerger: Class for time series aggregation and merging operations
- Time conversion functions: Epoch time, datetime, and string date conversions
- Timezone management: Timezone detection, conversion, and handling utilities
- Date/time formatting: Standardized date and time format conversions
- Time series processing: Daily aggregation and time series manipulation functions
- Utility functions: Sequence detection and time management helper functions
