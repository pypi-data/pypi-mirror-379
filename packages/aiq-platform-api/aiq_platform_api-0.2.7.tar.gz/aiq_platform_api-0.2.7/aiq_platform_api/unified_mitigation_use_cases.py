...
if __name__ == "__main__":
    ...
    if choice == TestChoice.LIST_RULES:
        list_mitigation_rules(client, limit=5)

    elif choice == TestChoice.CREATE_SIGMA:
    ...
    elif choice == TestChoice.CREATE_YARA:
    ...
    elif choice == TestChoice.CREATE_SNORT:
    ...
    elif choice == TestChoice.CREATE_SPL:
    ...
    elif choice == TestChoice.CREATE_MINIMAL:
        minimal_rule_data = {
    ...
    elif choice == TestChoice.LIST_ASSOCIATIONS:
        list_project_associations(client, limit=5)

    elif choice == TestChoice.LIST_WITH_RELATIONS:
        list_mitigations_with_relations(client, limit=5)

    elif choice == TestChoice.GET_TIMELINE:
