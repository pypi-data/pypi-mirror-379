...
- <code title="patch /api/v1/materials/{id}">client.v1.materials.<a href="./src/studyfetch_sdk/resources/v1/materials/materials.py">update</a>(id) -> <a href="./src/studyfetch_sdk/types/v1/material_update_response.py">MaterialUpdateResponse</a></code>
