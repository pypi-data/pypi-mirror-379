...
from ....types.v1.material_update_response import MaterialUpdateResponse
...
class MaterialsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        references: Iterable[material_create_params.Reference] | Omit = omit,
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=MaterialUpdateResponse,
        )
    ...
    def create_and_process(
        ...
        *,
        ...
        references: Iterable[material_create_and_process_params.Reference] | Omit = omit,
    ...
    def generate(
        ...
        *,
        ...
        references: Iterable[material_generate_params.Reference] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def generate_and_process(
        ...
        *,
        ...
        level: Literal["high_school", "college", "professional"] | Omit = omit,
        poll_interval_ms: float | Omit = omit,
        references: Iterable[material_generate_and_process_params.Reference] | Omit = omit,
        timeout_ms: float | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
