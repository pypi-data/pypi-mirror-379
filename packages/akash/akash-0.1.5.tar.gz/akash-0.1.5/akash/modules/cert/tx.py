...
class CertTx:
    ...
    def publish_client_certificate(
        ...
        try:
            ...
            return broadcast_transaction_rpc(
                ...
                wallet=wallet,
                messages=[msg],
                memo=memo or f"Publish client certificate for {wallet.address}",
    ...
    def create_certificate(
        ...
        try:
            ...
            # Generate private key (using secp256r1/NIST P-256 curve as used by Akash)
            ...
            # Store private key for mTLS (in production, use secure storage)
            ...
            result = self.publish_client_certificate(
                ...
                memo=memo or f"Create certificate for {wallet.address}",
                fee_amount=fee_amount,
                gas_limit=gas_limit,
                use_simulation=use_simulation,
            )
    ...
    def publish_server_certificate(
        ...
        try:
            ...
            return broadcast_transaction_rpc(
                ...
                wallet=wallet,
                messages=[msg],
                memo=memo or f"Publish server certificate for {wallet.address}",
                fee_amount=fee_amount,
                gas_limit=gas_limit,
                gas_adjustment=gas_adjustment,
                use_simulation=use_simulation,
    ...
    def revoke_client_certificate(
        ...
        try:
            ...
            return broadcast_transaction_rpc(
                ...
                wallet=wallet,
                messages=[msg],
                memo=memo or f"Revoke client certificate {serial}",
                fee_amount=fee_amount,
                gas_limit=gas_limit,
                gas_adjustment=gas_adjustment,
                use_simulation=use_simulation,
    ...
    def revoke_server_certificate(
        ...
        try:
            ...
            return broadcast_transaction_rpc(
                ...
                wallet=wallet,
                messages=[msg],
                memo=memo or f"Revoke server certificate {serial}",
                fee_amount=fee_amount,
                gas_limit=gas_limit,
                gas_adjustment=gas_adjustment,
                use_simulation=use_simulation,
    ...
    def create_certificate_for_mtls(
        ...
        try:
            ...
            # Generate EC public key PEM to match console exactly
