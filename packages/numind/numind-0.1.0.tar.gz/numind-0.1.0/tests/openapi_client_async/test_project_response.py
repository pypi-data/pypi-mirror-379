    ...
    def make_instance(self, include_optional) -> ProjectResponse:
        ...
        if include_optional:
            return ProjectResponse(
                ...
                name = '',
                description = '',
                template = numind.openapi_client_async.models.schema_response.SchemaResponse(),
                owner_user = '',
                owner_organization = '',
                created_at = '',
                updated_at = '',
                lock_state = True,
                shared = True,
                settings = numind.openapi_client_async.models.project_settings_response.ProjectSettingsResponse(
                    temperature = 0.0, 
