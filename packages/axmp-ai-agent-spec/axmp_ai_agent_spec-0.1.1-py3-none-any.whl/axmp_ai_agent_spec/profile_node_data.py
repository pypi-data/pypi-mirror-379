...
class AgentMemoryData(BaseModel):
    ...
    memory_type: ChatMemoryType = Field(..., description="The type of the memory node.")
...
class McpServerData(BaseModel):
    ...
    transport_type: TransportType = Field(
        ..., description="The transport type of the MCP server node."
    )
    type: MCPServerType = Field(..., description="The type of the MCP server node.")
    name: str = Field(
        ...,
