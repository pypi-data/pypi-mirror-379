...
class NinjaClient(SelfHealingMixin):
    ...
    async def send_task(
        ...
        **kwargs
        ...
        # Build request args, only including correlation_id if provided
        request_args = {
            'task': task,
        ...
        # Only add correlation_id if it was explicitly provided
        if correlation_id is not None:
            request_args['correlation_id'] = correlation_id
