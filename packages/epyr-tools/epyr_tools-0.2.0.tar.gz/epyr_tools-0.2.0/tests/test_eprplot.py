...
fig3, ax3 = epyr.plot_2d_waterfall(x_2d, y_2d, params_2d, title="Test 2D EPR Waterfall", offset_factor=0.3)
print("✅ 2D waterfall created successfully")

# Test with real EPR data if available
print("\n📂 Testing with real EPR data...")
try:
    x, y, params, filepath = epyr.eprload("examples/data/Rabi2D_GdCaWO4_13dB_3057G.DSC", plot_if_possible=False)
    if y is not None:
        if y.ndim == 1:
            ...
            fig6, ax6 = epyr.plot_2d_waterfall(x, y, params, title="Real 2D EPR Waterfall")
