...
import epyr
from epyr import (
    baseline, constants, eprload, fair, plot, 
    config, cli, plugins, performance
)
from epyr.lineshapes import (
    gaussian, lorentzian, voigtian, lshape, convspec, 
    lineshape_class, Lineshape
)
    ...
    def get_module_functions(self, module) -> List[Tuple[str, Any]]:
        ...
        for name, obj in inspect.getmembers(module):
            if (inspect.isfunction(obj) and 
                ...
                obj.__module__.startswith('epyr')):
...
class TestLineshapesComprehensive:
    ...
    def test_all_lineshape_functions(self, test_field_range):
        ...
        for derivative in [0, 1, 2]:
            for phase in [0, 0.5, 1.0]:
                result = gaussian(B, center=0, width=5, derivative=derivative, phase=phase)
    ...
    def test_factory_functions(self, test_field_range):
        ...
        factory_functions = [
            'create_gaussian', 'create_lorentzian', 'create_voigt', 
            'create_pseudo_voigt'
        ]
    ...
    def test_all_functions_documented(self):
        ...
        for module in modules_to_test:
            ...
            for func in functions:
                assert func.__doc__ is not None, f"Function {func.__name__} lacks documentation"
                assert len(func.__doc__.strip()) > 10, f"Function {func.__name__} has insufficient documentation"
