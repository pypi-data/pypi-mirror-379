...
class TestPhysicalConstants:
    ...
    def test_constant_consistency(self):
        ...
        if (hasattr(constants, 'GAUSS_TO_TESLA') and 
            hasattr(constants, 'TESLA_TO_GAUSS')):
    ...
    def test_nuclear_constants(self):
        ...
        if (hasattr(constants, 'NUCLEAR_MAGNETON') and 
            hasattr(constants, 'BOHR_MAGNETON')):
            mu_n = constants.NUCLEAR_MAGNETON
            mu_b = constants.BOHR_MAGNETON
...
class TestConstantsUtilities:
    ...
    def test_frequency_field_conversion(self):
        ...
        conversion_functions = [
            'field_to_frequency', 'frequency_to_field',
            'gauss_to_tesla', 'tesla_to_gauss'
        ]
