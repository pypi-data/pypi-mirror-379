...
class UpdateSubmissionDataRequestData(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if auth_second_factor_type (nullable) is None
        # and model_fields_set contains the field
        if self.auth_second_factor_type is None and "auth_second_factor_type" in self.model_fields_set:
            _dict['auth_second_factor_type'] = None
