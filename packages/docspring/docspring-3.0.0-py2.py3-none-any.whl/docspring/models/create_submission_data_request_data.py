...
class CreateSubmissionDataRequestData(BaseModel):
    ...
    fields: Optional[List[Optional[StrictStr]]] = None
    metadata: Optional[Dict[str, Any]] = None
    name: Optional[StrictStr] = None
    order: Optional[StrictInt] = None
    skipped: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["auth_phone_number_hash", "auth_provider", "auth_second_factor_type", "auth_session_id_hash", "auth_session_started_at", "auth_type", "auth_user_id_hash", "auth_username_hash", "email", "fields", "metadata", "name", "order", "skipped"]
