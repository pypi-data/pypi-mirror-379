...
class TestMockedInstallations:
    ...
    def test_individual_operator_install_methods(self, mock_install):
        ...
        operators_to_test = [
            ...
            ('install_openshift_cert_manager_operator', 'openshift-cert-manager-operator'),
            ('install_kueue_operator', 'kueue-operator'),
            ('install_openshift_custom_metrics_autoscaler_operator', 'openshift-custom-metrics-autoscaler-operator'),
        ]
    ...
    @patch('rhoshift.utils.operator.enhanced_operator.EnhancedOpenShiftOperatorInstaller.install_operator_with_stability')
    def test_enhanced_operator_install_methods(self, mock_install):
        ...
        rc, stdout, stderr = EnhancedOpenShiftOperatorInstaller.install_serverless_operator_enhanced()
...
class TestImportValidation:
    ...
    def test_all_core_imports(self):
        ...
        assert all([
            main, parse_args, install_operator,
            OpenShiftOperatorInstallManifest, run_command, HealthStatus,
            execute_resilient_operation, StabilityLevel,
