...
if T.TYPE_CHECKING:  # pragma: no cover
    from mypy_boto3_apigatewaymanagementapi import type_defs
...
class PostToConnectionRequest:
    boto3_raw_data: "type_defs.PostToConnectionRequestTypeDef" = dataclasses.field()
    ...
    @classmethod
    def make_one(
        cls, boto3_raw_data: T.Optional["type_defs.PostToConnectionRequestTypeDef"]
    ):
        if boto3_raw_data is None:
            return None
        return cls(boto3_raw_data=boto3_raw_data)
    ...
    def make_many(
        cls,
        boto3_raw_data_list: T.Optional[
            T.Iterable["type_defs.PostToConnectionRequestTypeDef"]
        ],
    ):
        if boto3_raw_data_list is None:
            return None
