...
class Authenticator(dns_common.DNSAuthenticator):
    ...
    def _setup_credentials(self) -> None:
        ...
        api_key = self.credentials.conf("api_key") or self.credentials.conf("dns_abion_api_key")
        if not api_key:
            raise errors.PluginError("dns_abion_api_key missing in the credentials INI file")

        api_url = self.credentials.conf("api_url") or self.credentials.conf("dns_abion_api_url")
        ttl = self.credentials.conf("dns_ttl") or self.credentials.conf("dns_abion_dns_ttl")
