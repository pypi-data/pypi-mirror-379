...
class VacancyPredictorApp:
    ...
    def create_main_interface(self):
        ...
        # NUEVO: TAB DE DUMP PROCESSOR (añadir como primera pestaña)
...
"""
    ...
    def on_dump_data_loaded(self, data):
        ...
        # Ajusta según el nombre de tu variable de datos
        self.current_data = data  # o como tengas tu variable principal
