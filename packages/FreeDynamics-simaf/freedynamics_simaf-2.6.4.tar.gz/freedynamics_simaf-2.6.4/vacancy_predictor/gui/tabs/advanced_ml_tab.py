...
class AdvancedMLTab:
    ...
    def create_visualization_tab(self):
        ...
        ttk.Button(controls_frame, text="k-fold", 
                  command=self.visualize_kfold).pack(side='right', padx=5)
    ...
    def visualize_kfold(self):
        """Método para añadir a tu clase AdvancedMLTab"""
        ...
        # Importar la función
        import vacancy_predictor.gui.tabs.kfold_visualization
        from vacancy_predictor.gui.tabs.kfold_visualization import plot_kfold_results
        # Preparar datos
        ...
        fig, results_df, stats = plot_kfold_results(model, X, y, cv_folds=5)
