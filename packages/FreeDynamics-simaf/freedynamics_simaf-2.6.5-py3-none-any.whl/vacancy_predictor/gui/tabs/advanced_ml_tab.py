...
class AdvancedMLTab:
    ...
    def create_visualization_tab(self):
        ...
        # Segunda fila de botones - AQUÍ ESTÁ TU BOTÓN K-FOLD MÁS VISIBLE
        row2_frame = ttk.Frame(controls_frame)
        row2_frame.pack(fill='x', pady=2)
        
        # Botón K-Fold más prominente
        self.kfold_btn = ttk.Button(row2_frame, 
                                text="🔄 K-Fold Cross Validation", 
                                command=self.visualize_kfold,
                                style="Accent.TButton")  # Estilo destacado si está disponible
        self.kfold_btn.pack(side='left', padx=5)
        
        # Botón de estado de K-Fold (opcional)
        ...
        # Área de gráficos (mantén tu código existente)
        self.viz_area = ttk.Frame(viz_frame)
        self.viz_area.pack(fill='both', expand=True, padx=10, pady=5)
