...
preference = ('PyQt4', importPyQt4), ('PySide', importPySide), ('PyQt5', importPyQt5), ('PySide6', importPySide6)
...
elif qt4_backend == 'PySide6':
    import PySide6
    mpl_qt4_backend = 'PySide6'
    qt4_backend_version = PySide6.__version__
else:
