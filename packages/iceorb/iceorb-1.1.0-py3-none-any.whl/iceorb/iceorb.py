...
def settings():
    s = {}
    # Standard paths
    s['config_dir'] = platformdirs.user_config_dir('iceorb')
    s['cache_dir'] = platformdirs.user_cache_dir('iceorb')
...
class Database():
    def __init__(self, path=None):
        self.path = path if path is not None else 'iceorb.db'
