...
class DescribeInlinePropertiesResource:
    ...
    def test_create_no_properties(self, respx_mock: Router):
    ...
    def test_create_basic_properties(self, respx_mock: Router):
        setup_sql_background_routes(respx_mock, result_data=[])
        ...
        assert state == {
            "provider": "TestProvider",
            "source_version": "c408a6aacda69eba84fb889ceaf41e82b3fa1ba20fa9353aa9b636e99ae62521",
            "remote_version": "1561699310f46927a28c50649c13e92930b27ba9e94ba6da9ec3b68b6f727927",
            "extension": None
        }

    def test_create_with_asat(self, respx_mock: Router):
        setup_sql_background_routes(respx_mock, result_data=[])
        # given an inline properties resource with basic properties
        prop_key = DefinitionRef(
            id="test-key", domain=Domain.Instrument, scope="TestScope", code="TestCode"
        ...
        assert state == {
            "provider": "TestProvider",
            "source_version": "8ebbe1f35888b6b7dd77234dcd53d358e7b3c5432b76de445e05e8c469d3bddc",
            "remote_version": "607e1a9cd1fbfa838ce44a382709c5766c1e53d6e5bd002bdc2fd54aa3030624",
            "extension": None
        }

    def test_create_with_provider_extension(self, respx_mock):
        setup_sql_background_routes(respx_mock, result_data=[])
        prop_key = DefinitionRef(
            id="test-key", domain=Domain.Instrument, scope="TestScope", code="TestCode"
        )
    ...
    def test_create_multiple_properties_with_optional_fields(self, respx_mock):
        setup_sql_background_routes(respx_mock, result_data=[])
    ...
    def test_create_custom_entity(self, respx_mock):
        setup_sql_background_routes(respx_mock, result_data=[])
    ...
    def test_create_sql_structured_property(self, respx_mock):
        setup_sql_background_routes(respx_mock, result_data=[])
    ...
    def test_update_with_changes(self, respx_mock):
        ...
        setup_sql_background_routes(respx_mock, result_data=[{"Content": csv_content}])
        #     mock the read
        routes = setup_sql_background_routes(respx_mock, result_data=[{"Content": csv_content}])
        #     mock the create
        exec_id = "abcdefg"
        routes["put"].mock(
            side_effect=[
        ...
        routes["result"].mock(
            side_effect=[
                ...
                httpx.Response(200, json=[]),  # create result
            ]
        )
        routes["status"].mock(
            side_effect=[
    ...
    def test_update_provider_change_triggers_delete(self, respx_mock):
        ...
        respx_mock.get(f"/honeycomb/api/SqlBackground/{exec_id}/jsonproper").mock(
            return_value=httpx.Response(200, json=[]),  # read, delete, create
        )
        ...
        assert new_state == {
            ...
            "extension": None,
            "remote_version": "1561699310f46927a28c50649c13e92930b27ba9e94ba6da9ec3b68b6f727927",
            "source_version": "5a0a7b1b43f98c445ad0d3ffd4f5065b3501c48a435e8bc8c1d3d9c4d209fae6"
        }
    ...
    def test_update_extension_calls_delete(self, respx_mock):
        ...
        assert new_state == {
            ...
            "extension": "NewExt",
            "remote_version": "1561699310f46927a28c50649c13e92930b27ba9e94ba6da9ec3b68b6f727927",
            "source_version": "cd5719e33919b842ac38a7de00b190bb0613f9a5046e7e9e093a28f341054089"
        }
