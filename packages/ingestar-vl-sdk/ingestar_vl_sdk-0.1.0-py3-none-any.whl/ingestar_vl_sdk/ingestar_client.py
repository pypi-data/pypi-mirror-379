...
class IngeStarSamplingParams(SamplingParams):
    def __init__(
        self,
...
DEFAULT_SAMPLING_PARAMS: dict[str, SamplingParams] = {
    "table": IngeStarSamplingParams(presence_penalty=1.0, frequency_penalty=0.005),
    "equation": IngeStarSamplingParams(presence_penalty=1.0, frequency_penalty=0.05),
    "[default]": IngeStarSamplingParams(presence_penalty=1.0, frequency_penalty=0.05),
    "[layout]": IngeStarSamplingParams(),
}
...
class IngeStarClient:
    def __init__(
        ...
        self.client = new_vlm_client(
            ...
            allow_truncated_content=True,  # Allow truncated content for IngeStar
        ...
        self.helper = IngeStarClientHelper(
            backend=backend,
            prompts=prompts,
