...
### Running SerialSrv After Installation

Once you have installed SerialSrv using the virtual environment method, you can run it anytime by following these steps:
...
cd serialsrv
venv\Scripts\activate
serialsrv --host 0.0.0.0 --port 8080 --log --test
```
...
- **Always activate the virtual environment** before running SerialSrv
- **Navigate to the serialsrv directory** first
...
SerialSrv 4 farklı response body türü oluşturur:
