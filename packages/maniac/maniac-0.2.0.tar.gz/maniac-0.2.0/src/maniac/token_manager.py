...
class TokenManager:
    def __init__(self, opts: TokenManagerOptions) -> None:
        ...
        # IMPORTANT: reuse caller's session if provided, else build one with certifi
    ...
    async def aclose(self) -> None:
        if getattr(self, "_owns_session", False) and not self._session.closed:
    ...
    async def _refresh(self, force: bool = False) -> None:
        ...
        # REUSE self._session (has certifi SSL)
