...
def activate_synapse(
    ...
    *,
    ...
    def _ls_copy(self, src: str, dst: str) -> None:
        ...
        # Prefer native copy if available and on same fs type
        try:
    ...
    def _ls_listdir(self, path: str) -> List[str]:
        ...
        try:
            ...
            try:
                # Fallback to glob of children (best-effort)
    ...
    # NEW compat surface for mirror_delta
