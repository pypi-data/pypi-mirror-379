...
## Updates v1.6.0
- Extensions:
  - Package functions are more generic with new module "helper"
  - Saving options in point_spatial_join()
  - Optional harmonizing layer CRS in map_with_basemap()
- Bugfixes:
  - Catching I/O errors when saving in functions of module "gistools" 
  - No automatical saving of buffer geometries in polygon_select()
  - verbose option in buffers() and polygon_select()
  - Checking layer CRS in map_with_basemap()
  - Fixed conflict between showing and saving map in map_with_basemap()
