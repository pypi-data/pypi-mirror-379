...
import biosim_client.api.simdata.models
from biosim_client.api.simdata import rest
from biosim_client.api.simdata.api_response import ApiResponse
from biosim_client.api.simdata.api_response import T as ApiResponseT
from biosim_client.api.simdata.configuration import Configuration
from biosim_client.api.simdata.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(biosim_client.api.simdata.models, klass)
