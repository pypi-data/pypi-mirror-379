...
class EquivalenceClassesHandler():
    """
    A class used to extract equivalence classes from a regression tree.

    Attributes
    ----------
    test_tree : TestTree
        The regression tree structure.
    ...
    get_equivalence_classes()
        Extracts and formats equivalence classes from the regression tree.
    ...
    ROOT_INDEX = 0      # Root index of regression trees is always 0
    eqclass_prio = []
    ...
    def __init__(
        ...
        Args:
            test_tree : The regression tree used for extracting equivalence classes.
