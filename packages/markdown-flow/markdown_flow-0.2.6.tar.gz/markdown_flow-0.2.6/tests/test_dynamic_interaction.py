...
async def test_chinese_restaurant_scenario():
    """测试中文餐厅场景 - 完整的用户交互流程"""
    print("\n=== 中文餐厅场景测试 ===")
...
格式要求：提供具体菜品选项"""
    ...
    try:
        ...
        mf = MarkdownFlow(
            ...
            enable_dynamic_interaction=True
        )

        # 第一步：生成动态交互
        print("--- 生成动态交互 ---")
        result1 = await mf.process(
            block_index=0,
...
async def test_english_education_scenario():
    """测试英文教育场景 - 完整的用户交互流程"""
    print("\n=== 英文教育场景测试 ===")
...
async def test_japanese_fitness_scenario():
    """测试日文健身场景 - 完整的用户交互流程"""
    print("\n=== 日文健身场景测试 ===")
...
async def test_korean_travel_scenario():
    """测试韩文旅游场景 - 完整的用户交互流程"""
    print("\n=== 한국어 여행 시나리오 테스트 ===")
...
async def test_complex_job_consultation_scenario():
    """测试复杂的职业咨询场景 - 多步骤交互流程"""
    print("\n=== 复杂职业咨询场景测试 ===")
...
async def test_text_input_scenario():
    """测试文本输入场景 - 用户自定义输入"""
    print("\n=== 文本输入场景测试 ===")
...
async def test_variable_context_cuisine_scenario():
    """测试变量上下文场景 - 菜系菜品依赖"""
    print("\n=== 变量上下文场景测试 ===")
...
async def test_variable_context_skill_project_scenario():
    """测试变量上下文场景 - 技能项目依赖（英文）"""
    print("\n=== 技能-项目上下文测试（英文） ===")
