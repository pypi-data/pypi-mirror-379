...
from tai_sql import *
from database.custom_generators import ModelsGenerator, CRUDGenerator, ERDiagramGenerator
...
generate(
    ...
    CRUDGenerator(
        output_dir='tai_chat/api/database', # Directorio donde se generarán los CRUDs
    ),
    ERDiagramGenerator(
