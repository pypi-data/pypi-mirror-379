...
public:
    ...
    PyReader(
        ...
        reader = std::make_shared<Reader>(path, parallel, zoom_correction);
...
PYBIND11_MODULE(bigwig_io, m, py::mod_gil_not_used()) {
    ...
    py::class_<PyReader>(m, "Reader")
        .def(py::init<const std::string&, uint64_t>(), "BigWig and BigBed reader",
        ...
        .def("read_values", &PyReader::read_values,
