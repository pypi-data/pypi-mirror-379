...
class RedgtechAPI:
    ...
    async def get_data(self, token: str | None = None) -> dict[str, Any]:
    ...
    async def set_switch_state(self, endpoint_id: str, state: bool, token: str | None = None) -> bool:
    ...
    async def set_light_brightness(self, endpoint_id: str, brightness: int, token: str | None = None) -> bool:
