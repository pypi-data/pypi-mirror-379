...
def test_generate_table_description(agent_instance):
    ...
    result = agent_instance.generate_table_description(df)
...
def test_execute_task_success(agent_instance):
    ...
    with patch.object(agent_instance, 'generate_table_description', return_value=mock_description) as mock_generate:
