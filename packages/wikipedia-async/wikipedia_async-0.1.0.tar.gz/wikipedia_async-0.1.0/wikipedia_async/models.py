...
class Language(BaseModel):
    ...
    english_name: Optional[str] = Field(None, description="English name of the language")
...
class WikiPage(BaseModel):
    ...
    references: List[HttpUrl] = Field(default_factory=list, description="External links")
    links: List[str] = Field(default_factory=list, description="Internal Wikipedia links")
...
class BatchResult(BaseModel):
    ...
    successful: List[WikiPage] = Field(default_factory=list, description="Successfully retrieved pages")
    failed: List[Dict[str, Any]] = Field(default_factory=list, description="Failed requests with errors")
