...
from wikipedia_async.helpers.section_helpers import SectionResult
...
class WikiPage(BaseModel):
    ...
    sections: SectionResult = Field(
        default_factory=SectionResult, description="Section titles with content"
    )
