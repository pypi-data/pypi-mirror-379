...
class ReadAdata(QWidget):
    ...
    def show_components(self):
        ...
        self.json_file = widgets.FileEdit(label="ColorMap json file",tooltip="Optional: Load a json file for tissue color mapping")
    ...
    def load_embryo(self):
        ...
        DisplayEmbryo(self.viewer, self.embryo, self.json_file.value)
