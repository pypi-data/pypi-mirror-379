...
class Site:
    ...
    def __init__(self, name: str, *, kind: str, arguments: dict[str, str]|None = None,
                 aspects: t.Iterable[Aspect] = (), warn_after: datetime.timedelta|None = None):
        """
...
class Volume:
    ...
    def __init__(self, name: str, *, sites: t.Iterable[Site], aspects: t.Iterable[Aspect],
...
class Logging:
    ...
    def __init__(self, *, min_severity: str|None, max_severity: str|None, out: t.Iterable["Logging.Out"],
                 formatter: "Logging.Formatter", exclude: t.Iterable["Logging.Exclude"]):
        """
