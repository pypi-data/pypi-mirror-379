...
class SimpleCondition(parzzley.sync.logger.Exclude.Condition):
    ...
    def __init__(self, *, message: str|None = None, message_re: str|None = None, item: str|None = None,
                 item_re: str|None = None, severity_below: parzzley.sync.logger.Severity|None = None,
