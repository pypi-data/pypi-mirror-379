...
class Entry:
    ...
    def __init__(self, *, severity: Severity, message: str, message_args: t.Iterable[t.Any],
                 item: "parzzley.fs.Item|None", stream: str|None):
        """
...
class Logging:
    ...
    def __init__(self, *, min_severity: Severity|None, max_severity: Severity|None = None,
                 out: t.Iterable["Out"], formatter: "Formatter", exclude: t.Iterable["Exclude"] = ()):
        """
