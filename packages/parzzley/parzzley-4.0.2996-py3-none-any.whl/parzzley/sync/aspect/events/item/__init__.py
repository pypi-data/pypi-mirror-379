...
class _WithSetItemInfo(abc.ABC):
    ...
    @abc.abstractmethod
    def set_item_info(self, item_type: "parzzley.fs.ItemType", stream_cookie, *,
...
class DetermineType(_Event, _WithStreamCookie, abc.ABC):
    ...
    @abc.abstractmethod
    def set_item_type(self, item_type: "parzzley.fs.ItemType", *,
                      for_site: "parzzley.fs.TSiteInput|None" = None) -> None:
        """
...
class SetUpWorkingItems(_EventAfterMainStreamMasterSiteDetermined, _WithStreamCookie, _WithWorkingItems, abc.ABC):
    ...
    @abc.abstractmethod
    def add_working_item(self, working_item: "parzzley.fs.TItemInput", *,
                         for_site: "parzzley.fs.TSiteInput|None" = None) -> None:
        """
        Add a working item.
    ...
    @abc.abstractmethod
    def remove_working_item(self, working_item: "parzzley.fs.TItemInput", *,
                            for_site: "parzzley.fs.TSiteInput|None" = None) -> None:
        """
...
class RefreshItemsBook(_EventAfterItemTypeKnown, abc.ABC):
    ...
    @abc.abstractmethod
    def updated_cookie(self, stream_name: str, *,
                       for_site: "parzzley.fs.TSiteInput|None" = None) -> "parzzley.fs.TCookie":
        """
    ...
    @abc.abstractmethod
    def set_item_book_entry(self, item_type: "parzzley.fs.ItemType", cookies: dict[str, object], *,
                            for_site: "parzzley.fs.TSiteInput|None" = None) -> None:
        """
