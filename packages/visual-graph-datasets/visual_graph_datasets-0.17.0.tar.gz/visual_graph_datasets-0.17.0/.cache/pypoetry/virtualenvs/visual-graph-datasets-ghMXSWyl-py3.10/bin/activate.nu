...
export-env {
    ...
    let virtual_env = '/media/ssd/Programming/visual_graph_datasets/.cache/pypoetry/virtualenvs/visual-graph-datasets-ghMXSWyl-py3.10'
    let bin = 'bin'
    ...
    let new_env = (if (is-env-true 'VIRTUAL_ENV_DISABLE_PROMPT') {
      ...
      let virtual_prompt = (if ('visual-graph-datasets-py3.10' == '') {
          $'(char lparen)($virtual_env | path basename)(char rparen) '
      } else {
          '(visual-graph-datasets-py3.10) '
      })
