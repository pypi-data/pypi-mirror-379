        ...
        **kwargs: Any,
        ...
        if getattr(span_holder, "first_token_time", None) is None:
            ...
            try:
                ...
                _get_unified_unknown_model = lambda **_: "unknown"
            model_name = (
        ...
        **kwargs: Any,
        ...
        if model_name is None:
            try:
                ...
                _get_unified_unknown_model = lambda **_: "unknown"
            existing_model = getattr(self.spans.get(run_id, None), "request_model", None) if isinstance(self.spans, dict) else None
