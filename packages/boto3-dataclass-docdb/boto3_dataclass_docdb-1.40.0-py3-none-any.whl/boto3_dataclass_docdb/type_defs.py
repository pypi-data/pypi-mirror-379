...
if T.TYPE_CHECKING:  # pragma: no cover
    from mypy_boto3_docdb import type_defs
...
class ClusterMasterUserSecret:
    boto3_raw_data: "type_defs.ClusterMasterUserSecretTypeDef" = dataclasses.field()
    ...
    @classmethod
    def make_one(
        cls, boto3_raw_data: T.Optional["type_defs.ClusterMasterUserSecretTypeDef"]
    ):
        if boto3_raw_data is None:
            return None
        return cls(boto3_raw_data=boto3_raw_data)
    ...
    def make_many(
        cls,
        boto3_raw_data_list: T.Optional[
            T.Iterable["type_defs.ClusterMasterUserSecretTypeDef"]
        ],
    ):
        if boto3_raw_data_list is None:
            return None
...
class DBCluster:
    ...
    def MasterUserSecret(self):  # pragma: no cover
        return ClusterMasterUserSecret.make_one(self.boto3_raw_data["MasterUserSecret"])
