...
class UsernameAPI:
    ...
    def list(
        ...
        Args:
            phone_number (str): Phone number in international format (e.g., +62812345678 or 62812345678)
            extra_headers (dict[str, str] | None): Additional headers to include in the request.
                Use this to pass X-API-Key for WhatsApp authentication and X-Tenant-ID for multi-tenancy.
