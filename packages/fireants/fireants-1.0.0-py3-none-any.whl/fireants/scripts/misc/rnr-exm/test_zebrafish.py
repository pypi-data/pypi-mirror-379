...
def run_registration_val(config):
    ...
    affine = AffineRegistration([32, 16, 8, 4], iters, fixed_image, moving_image, \
            ...
            loss_type='mi', optimizer='Adam', optimizer_lr=5e-2, optimizer_params={}, cc_kernel_size=cc_size, init_rigid=rigid, mi_kernel_type='gaussian')
    affine.optimize()
    ...
    deformable = GreedyRegistration(scales=[4, 2], iterations=[50, 50], fixed_images=fixed_image, moving_images=moving_image,
                                    cc_kernel_size=cc_size, deformation_type='compositive',  loss_type='fusedcc',
