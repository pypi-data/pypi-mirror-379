...
sudo dpkg -i ../upas-cli_1.0.3-1_amd64.deb
...
```
../upas-cli_1.0.3-1_amd64.deb
../upas-cli_1.0.3-1_armhf.deb
../upas-cli_1.0.3-1_arm64.deb
```
...
- `upas-cli_v1.0.3-1_amd64.deb`
- `upas-cli_v1.0.3-1_armhf.deb`
- `upas-cli_v1.0.3-1_arm64.deb`
...
_Ce guide est maintenu par l'équipe BitsDiver pour UPAS CLI v1.0.3+_
