...
```bash
# Pour AMD64
wget https://github.com/BitsDiver/upas-cli/releases/latest/download/upas-cli_1.0.10-1_amd64.deb

# Pour ARM64 (Raspberry Pi 4+)
wget https://github.com/BitsDiver/SignalMiners/Reverse/upas-cli/releases/latest/download/upas-cli_1.0.10-1_arm64.deb

# Pour ARMHF (Raspberry Pi ancien)
wget https://github.com/BitsDiver/SignalMiners/Reverse/upas-cli/releases/latest/download/upas-cli_1.0.10-1_armhf.deb
```
...
wget https://github.com/BitsDiver/upas-cli/releases/latest/download/upas-cli_1.0.10-1_arm64.deb

# Pi 3, Zero 2 (32-bit OS)
wget https://github.com/BitsDiver/upas-cli/releases/latest/download/upas-cli_1.0.10-1_armhf.deb
