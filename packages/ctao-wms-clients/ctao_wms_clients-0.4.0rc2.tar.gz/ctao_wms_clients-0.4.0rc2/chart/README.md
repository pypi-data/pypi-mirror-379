...
| diracx.developer.urls.dex | string | `"http://wms-dex:32002"` |  |
...
| diracx.dex.config.issuer | string | `"http://wms-dex:32002"` |  |
| diracx.dex.config.staticClients[0].id | string | `"d396912e-2f04-439b-8ae7-d8c585a34790"` |  |
| diracx.dex.config.staticClients[0].name | string | `"CLI app"` |  |
| diracx.dex.config.staticClients[0].public | bool | `true` |  |
| diracx.dex.config.staticClients[0].redirectURIs[0] | string | `"http://wms-diracx:8000/api/auth/device/complete"` |  |
| diracx.dex.config.staticClients[0].redirectURIs[1] | string | `"http://wms-diracx:8000/api/auth/authorize/complete"` |  |
| diracx.dex.config.staticPasswords[0].email | string | `"admin@example.com"` |  |
| diracx.dex.config.staticPasswords[0].hash | string | `"$2a$10$2b2cU8CPhOTaGrs1HRQuAueS7JTT5ZHsHSzYiFPm1leZck7Mc8T4W"` |  |
| diracx.dex.config.staticPasswords[0].username | string | `"admin"` |  |
