...
create_logger(logging.DEBUG,'kxy.mall.api','production',filename='log/app',file_type='log',backupCount=5,maxBytes=10000,mutiple_process=False,cleanup_mode='zip',disk_max=1)
