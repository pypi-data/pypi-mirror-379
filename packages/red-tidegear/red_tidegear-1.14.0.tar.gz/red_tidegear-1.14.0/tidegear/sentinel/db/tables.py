...
from discord import Guild, Member, Object, Role, Thread, User, abc
...
class Moderation(Table):
    ...
    async def target(self, /, *, cache: bool = True) -> PartialChannel | PartialRole | PartialUser:
        ...
        result: PartialChannel | PartialRole | PartialUser | None = None
