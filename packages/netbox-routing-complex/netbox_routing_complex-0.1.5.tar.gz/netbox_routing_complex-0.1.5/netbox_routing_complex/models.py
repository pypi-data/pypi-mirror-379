...
class BFDConfig(NetBoxModel):
    ...
    def __str__(self):
        ...
        """
        return f'Hello: {self.hello_interval}ms, Multiplier: {self.multiplier}, Desc: {self.description}'
    
    def get_absolute_url(self):
        '''Get the absolute URL to this object'''
        return reverse('plugins:netbox_routing_complex:bfdconfig', args=[self.pk])