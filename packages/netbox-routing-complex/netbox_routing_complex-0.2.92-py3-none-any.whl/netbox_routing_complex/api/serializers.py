...
from ..models import BFDConfig, BGPPeer, BGPSessionConfig
...
class BGPPeerSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        model = BGPPeer
        fields = (
            'id', 'name', 'peer_ip', 'session_config', 'tags', 'custom_fields', 'created', 'last_updated'
        )
        brief_fields = ('id', 'name', 'peer_ip', 'session_config')