...
class BGPPeerTable(NetBoxTable):
    class Meta(NetBoxTable.Meta):
        model = BGPPeer
        fields = ('pk', 'id', 'name', 'peer_ip', 'session_config')
        default_columns = ('name', 'peer_ip', 'session_config')

class BGPPeerGroupTable(NetBoxTable):
    class Meta(NetBoxTable.Meta):
        model = BGPPeerGroup
        fields = ('pk', 'id', 'device', 'name', 'description', 'session_config')
        default_columns = ('device', 'name', 'description', 'session_config')