...
class BuildAssetsCommand(_build_py):
...
class CustomBdistWheel(_bdist_wheel):
    def run(self):
        self.run_command("build_py")   # this will call your BuildAssetsCommand
        super().run()

setup(name='catsim_test',
      version='0.0.4',
      #ext_modules = [Extension("dummy", sources=["gecatsim/clib_build/src/BaseObject.cpp"])],
      #cmdclass = {"build_ext": BuildAssetsCommand},
      #cmdclass = {"build_py": BuildAssetsCommand},
      cmdclass={
        "build_py": BuildAssetsCommand,
