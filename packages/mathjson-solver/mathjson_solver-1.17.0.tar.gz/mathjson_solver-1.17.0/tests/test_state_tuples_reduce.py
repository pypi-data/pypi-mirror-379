...
def test_running_sum_and_product():
    ...
    expression = [
        ...
        ["Appended",
            ["Appended",
                ["Array"],
                ["Add", ["AtIndex", "accumulator", 0], "current_item"]        # new_sum = old_sum + item
            ],
            ["Multiply", ["AtIndex", "accumulator", 1], "current_item"]    # new_product = old_product * item
        ],
        ["Variable", "accumulator"],
        ["Variable", "current_item"],
        ["Variable", "index"]
...
def test_simple_dual_accumulation():
    ...
    expression = [
        ...
        ["Appended",
            ...
            ["Max", ["Array", ["AtIndex", "accumulator", 1], "current_item"]]  # new_max = max(old_max, item)
        ],
        ["Variable", "accumulator"],
        ["Variable", "current_item"],
        ["Variable", "index"]
