...
from .impersonation import OptionalImpersonation
from .token import (
    TenantToken,
    SystemToken,
    OptionalAnyToken,
    OptionalAnyTokenT,
    is_tenant as is_tenant_token,
    is_system as is_system_token,
)
...
class BaseCredentials(
    ...
    token: Annotated[OptionalAnyToken, Field(None, description="Token")] = None


class TenantCredentials(
    GenericCredentials[
        Literal[Domain.TENANT], UUID, UUID, ListOfStrings, ListOfStrings, TenantToken
    ]
):
    ...
    token: Annotated[TenantToken, Field(..., description="Token")]


class SystemCredentials(
    GenericCredentials[
        Literal[Domain.SYSTEM], UUID, None, ListOfStrings, ListOfStrings, SystemToken
    ]
):
    ...
    roles: Annotated[ListOfStrings, Field(..., description="Roles")]
    scopes: Annotated[ListOfStrings, Field(..., description="Scopes")]
    token: Annotated[SystemToken, Field(..., description="Token")]
...
def is_authenticated(
    ...
    return (
        ...
        and authentication.credentials.token is not None
    )
...
def is_tenant(
    ...
    return (
        ...
        and authentication.credentials.scopes is not None
        and authentication.credentials.token is not None
        and is_tenant_token(authentication.credentials.token)
    )
...
def is_system(
    ...
    return (
        ...
        and authentication.credentials.token is not None
        and authentication.credentials.token is not None
        and is_system_token(authentication.credentials.token)
    )
