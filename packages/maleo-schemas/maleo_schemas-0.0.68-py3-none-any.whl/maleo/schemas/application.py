...
from maleo.mixins.identity import Name
...
class ApplicationContext(BaseModel):
    environment: Environment = Field(..., description="Application's environment")
    key: Key = Field(..., description="Application's key")
...
class ApplicationSettings(BaseSettings):
    ...
    SERVICE_NAME: Annotated[Name[str], Field(..., description="Application's name")]
