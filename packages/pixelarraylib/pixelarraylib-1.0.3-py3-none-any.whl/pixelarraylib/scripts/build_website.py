...
"""
python -m pixelarraylib.scripts.build_website \
--access_key_id=LTAI5tHe2nVua33gRRQRq9Sy \
--access_key_secret=ikRURTOHTh7Z52FfHksrP5L9lbmNfO \
--image_name=test-server \
--region_id=cn-beijing \
--acr_username=pixelarrayai \
--acr_password=080Gongyong_ \
--acr_namespace=test \
--acr_repository=test-server \
--cpu=0.5 \
--memory=1
"""
