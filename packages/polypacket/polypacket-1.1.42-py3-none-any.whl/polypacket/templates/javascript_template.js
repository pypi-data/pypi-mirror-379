function ${proto.namespace}_send_req(req, callback) {
...
function ${proto.namespace}_new_req()
{
  var req = {
    url: "/${proto.namespace}_service",
    packet: {
        packetType: "unkown"
    }};
...
function ${proto.namespace}_sendPing(callback)
{
  var req = ${proto.namespace}_new_req();
  req.packet.packetType="Ping";

  ${proto.namespace}_send_req(req, callback);
}
...
/**
  ...
  */
function ${proto.namespace}_send${packet.camel()}(\
