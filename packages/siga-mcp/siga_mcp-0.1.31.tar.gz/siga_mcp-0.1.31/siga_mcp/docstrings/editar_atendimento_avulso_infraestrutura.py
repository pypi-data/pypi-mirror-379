...
def docs() -> str:
    return dedent("""\
            ...
            **Validação de área:**
            Esta função é específica para área Infraestrutura (área=2). Tentativas de alterar para outras áreas serão rejeitadas com orientação para excluir e recriar o atendimento na função correta.
            ...
            **Em caso de erro de validação (área inválida):**
            ...
            <erro_validacao sistema="SIGA" funcao="editar_atendimento_avulso_infraestrutura">
                <erro sistema="SIGA">
                    ...
                    <area_informada>1</area_informada>
                    <mensagem>Não é possível alterar a área para 1. Esta função é específica para área Infraestrutura (2). Para alterar para Sistemas, exclua este atendimento e crie um novo na função editar_atendimento_avulso_sistemas. Sugestão: peça à IA para replicar este lançamento e solicite a exclusão do atendimento incorreto.</mensagem>
                </erro>
            </erro_validacao>
            ```
            ...
            **Em caso de outros erros:**
            ...
            Args:
                ...
                area (int, optional): Área do atendimento. Para infraestrutura deve ser sempre 2. Tentativas de usar valores diferentes resultarão em erro. Defaults to 2.
            ...
            Examples:
                ...
                ...     descricao_atendimento="Teste",
                ...     codigo_analista=789,
                ...     area=1  # Erro! Tentando alterar para Sistemas
                ... )
            ...
            Notes:
                ...
                - **Validação de área**: Esta função só aceita área=2 (Infraestrutura). Para Sistemas (área=1), use editar_atendimento_avulso_sistemas
