...
**Validação de área:**
Esta função é específica para área Sistemas (área=1). Tentativas de alterar para outras áreas
serão rejeitadas com orientação para excluir e recriar o atendimento na função correta.
...
**Em caso de erro de validação (área inválida):**
```xml
<erro_validacao sistema="SIGA" funcao="editar_atendimento_avulso_sistemas">
    <erro sistema="SIGA">
        <status>erro</status>
        <tipo_erro>area_invalida</tipo_erro>
        <area_informada>2</area_informada>
        <mensagem>Não é possível alterar a área para 2. Esta função é específica para área Sistemas (1). Para alterar para Infraestrutura, exclua este atendimento e crie um novo na função editar_atendimento_avulso_infraestrutura. Sugestão: peça à IA para replicar este lançamento e solicite a exclusão do atendimento incorreto.</mensagem>
    </erro>
</erro_validacao>
```
...
Args:
    ...
    area (int, optional): Área do atendimento. Para sistemas deve ser sempre 1. Tentativas de usar valores diferentes resultarão em erro. Defaults to 1.
...
Returns:
    str: XML formatado contendo:
        ...
        - Em caso de área inválida: status "erro" com orientação para excluir e recriar 
...
Examples:
    ...
    >>> # Exemplo tentando alterar área (retorna erro)
    >>> xml = await editar_atendimento_avulso_sistemas(
    ...     codigo_atendimento=123,
    ...     data_inicio="2024-01-15 09:00:00",
    ...     data_fim="2024-01-15 17:00:00",
    ...
    ...     descricao_atendimento="Teste",
    ...     codigo_analista=789,
    ...     area=2  # Erro! Tentando alterar para Infraestrutura
    ... )
...
Notes:
    ...
    - **Validação de área**: Esta função só aceita área=1 (Sistemas). Para Infraestrutura (área=2), use editar_atendimento_avulso_infraestrutura
    - **Sugestão para mudança de área**: Solicite à IA para replicar o lançamento na função correta e excluir o incorreto
