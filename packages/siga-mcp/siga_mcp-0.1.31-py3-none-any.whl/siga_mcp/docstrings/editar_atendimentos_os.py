...
<ordens_servico os="123" dataIni="2024-01-15 09:00:00" analista="456"
    ...
    <ordem_servico sistema="SIGA">
        <status>erro</status>
        <mensagem>Atendimento não encontrado em OS. Tente buscar nas funções editar_atendimento_avulso_sistemas ou editar_atendimento_avulso_infraestrutura.</mensagem>
    </ordem_servico>
</ordens_servico>
```
