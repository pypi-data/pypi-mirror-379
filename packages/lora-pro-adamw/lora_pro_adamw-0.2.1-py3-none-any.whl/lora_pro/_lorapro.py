...
def _solve_sylvester(A: torch.Tensor, B: torch.Tensor, C: torch.Tensor) -> torch.Tensor:
    """Solve the Sylvester equation using the helper formulation from the official LoRA-Pro release."""
...
def lorapro_full_adjustment(
    ...
    """Apply the LoRA-Pro gradient corrections as implemented in the official release."""
    device = gA.device
