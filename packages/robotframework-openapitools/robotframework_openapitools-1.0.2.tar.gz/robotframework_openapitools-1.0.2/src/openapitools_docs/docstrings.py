...
<br>
Another use case for `IGNORE` is in situations where a certain `error_code` will only be returned when the `parameter` is omitted from the request, e.g. a required `If-Match` header.
