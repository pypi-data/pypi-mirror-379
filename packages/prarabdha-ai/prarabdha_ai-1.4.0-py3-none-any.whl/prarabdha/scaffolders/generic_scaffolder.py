...
class GenericScaffolder:
    ...
    def _create_backend_structure(self, project_path, framework):
        """Create backend directory structure based on language/framework."""
        create_directory(project_path / "tests")
        
        # Create framework-specific structures
        if framework == "Python":
            # Python structure
            self._create_python_backend_structure(project_path, framework)
        elif framework == "Java":
            # Java structure
            self._create_java_backend_structure(project_path, framework)
        elif framework == "Node.js":
            # Node.js structure
            self._create_nodejs_backend_structure(project_path, framework)
    
    def _create_python_backend_structure(self, project_path, framework):
        """Create Python backend structure."""
        # Create main application directory
        create_directory(project_path / "app")
        
        # Create app subdirectories
        app_dir = project_path / "app"
        create_directory(app_dir / "api")
        create_directory(app_dir / "services")
        create_directory(app_dir / "models")
        create_directory(app_dir / "middlewares")
        create_directory(app_dir / "utils")
        create_directory(app_dir / "config")
        create_directory(app_dir / "database")
        
        # Create Flask boilerplate (default for Python)
        self._create_flask_backend(project_path, app_dir)
    
    def _create_java_backend_structure(self, project_path, framework):
        """Create Java Spring Boot structure."""
        # Create Maven/Gradle structure
        create_directory(project_path / "src" / "main" / "java" / "com" / "example" / "app")
        create_directory(project_path / "src" / "main" / "resources")
        create_directory(project_path / "src" / "test" / "java" / "com" / "example" / "app")
        
        # Create Java package structure
        java_dir = project_path / "src" / "main" / "java" / "com" / "example" / "app"
        create_directory(java_dir / "controller")
        create_directory(java_dir / "service")
        create_directory(java_dir / "repository")
        create_directory(java_dir / "model")
        create_directory(java_dir / "config")
        create_directory(java_dir / "dto")
        create_directory(java_dir / "exception")
        
        self._create_spring_boot_backend(project_path, java_dir)
    
    def _create_nodejs_backend_structure(self, project_path, framework):
        """Create Node.js backend structure."""
        # Create src directory with Node.js structure
        ...
        create_directory(src_dir / "database")
        
        self._create_express_backend(project_path, src_dir)
    
    def _create_frontend_structure(self, project_path, framework):
        """Create frontend directory structure based on framework."""
        # Create framework-specific structures
        if framework == "React":
    ...
    def _create_react_structure(self, project_path):
        ...
        create_directory(src_dir / "assets")
        
        self._create_react_frontend(project_path, src_dir)
    
    def _create_nextjs_structure(self, project_path):
        """Create Next.js frontend structure."""
        # Create Next.js-specific directories
        create_directory(project_path / "public")
        create_directory(project_path / "src")
        create_directory(project_path / "pages")
        create_directory(project_path / "components")
        create_directory(project_path / "styles")
        create_directory(project_path / "lib")
        create_directory(project_path / "tests")
        
        self._create_nextjs_frontend(project_path, project_path / "src")
    
    def _create_flask_backend(self, project_path, src_dir):
...
'''
        write_file(project_path / "app" / "api" / "routes.py", api_routes)
...
'''
        write_file(project_path / "app" / "services" / "user_service.py", user_service)
...
'''
        write_file(project_path / "app" / "models" / "user.py", user_model)
...
'''
        write_file(project_path / "app" / "middlewares" / "auth.py", auth_middleware)
...
'''
        write_file(project_path / "app" / "utils" / "helpers.py", utils)
...
class ProductionConfig(Config):
    ...
    DEBUG = False
'''
        write_file(project_path / "app" / "config" / "settings.py", config)
...
'''
    ...
    def _create_fastapi_backend(self, project_path, src_dir):
...
'''
        write_file(project_path / "src" / "main.py", app_content)
...
'''
        write_file(project_path / "src" / "api" / "routes.py", api_routes)
...
'''
    ...
    def _create_spring_boot_backend(self, project_path, src_dir):
...
'''
        write_file(project_path / "src" / "main" / "java" / "com" / "example" / "app" / "Application.java", main_app)
...
'''
        write_file(project_path / "src" / "main" / "java" / "com" / "example" / "app" / "api" / "ApiController.java", controller)
...
'''
        write_file(project_path / "src" / "main" / "java" / "com" / "example" / "app" / "services" / "UserService.java", user_service)
...
'''
        write_file(project_path / "src" / "main" / "java" / "com" / "example" / "app" / "models" / "User.java", user_model)
...
'''
        write_file(project_path / "pom.xml", pom_xml)
    
    def _create_express_backend(self, project_path, src_dir):
...
module.exports = app;
'''
        write_file(project_path / "src" / "index.js", app_content)
...
'''
        write_file(project_path / "src" / "api" / "routes.js", api_routes)
...
'''
        write_file(project_path / "src" / "services" / "userService.js", user_service)
...
'''
        write_file(project_path / "src" / "models" / "User.js", user_model)
...
'''
        write_file(project_path / "package.json", package_json)
    
    def _create_react_frontend(self, project_path, src_dir):
...
'''
    ...
    def _create_nextjs_frontend(self, project_path, src_dir):
